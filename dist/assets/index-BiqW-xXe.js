 ...
 */var Jh;function l0(){if(Jh)return ht;Jh=1;var s=Symbol.for("react.element"),e=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),a=Symbol.for("react.profiler"),l=Symbol.for("react.provider"),d=Symbol.for("react.context"),u=Symbol.for("react.forward_ref"),h=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),g=Symbol.for("react.lazy"),_=Symbol.iterator;function y(L){return L===null||typeof L!="object"?null:(L=_&&L[_]||L["@@iterator"],typeof L=="function"?L:null)}var S={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},E=Object.assign,w={};function v(L,W,ye){this.props=L,this.context=W,this.refs=w,this.updater=ye||S}v.prototype.isReactComponent={},v.prototype.setState=function(L,W){if(typeof L!="object"&&typeof L!="function"&&L!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,L,W,"setState")},v.prototype.forceUpdate=function(L){this.updater.enqueueForceUpdate(this,L,"forceUpdate")};function x(){}x.prototype=v.prototype;function N(L,W,ye){this.props=L,this.context=W,this.refs=w,this.updater=ye||S}var b=N.prototype=new x;b.constructor=N,E(b,v.prototype),b.isPureReactComponent=!0;var D=Array.isArray,V=Object.prototype.hasOwnProperty,z={current:null},F={key:!0,ref:!0,__self:!0,__source:!0};function ue(L,W,ye){var j,le={},he=null,Ae=null;if(W!=null)for(j in W.ref!==void 0&&(Ae=W.ref),W.key!==void 0&&(he=""+W.key),W)V.call(W,j)&&!F.hasOwnProperty(j)&&(le[j]=W[j]);var ce=arguments.length-2;if(ce===1)le.children=ye;else if(1<ce){for(var ae=Array(ce),be=0;be<ce;be++)ae[be]=arguments[be+2];le.children=ae}if(L&&L.defaultProps)for(j in ce=L.defaultProps,ce)le[j]===void 0&&(le[j]=ce[j]);return{$$typeof:s,type:L,key:he,ref:Ae,props:le,_owner:z.current}}function ve(L,W){return{$$typeof:s,type:L.type,key:W,ref:L.ref,props:L.props,_owner:L._owner}}function T(L){return typeof L=="object"&&L!==null&&L.$$typeof===s}function P(L){var W={"=":"=0",":":"=2"};return"$"+L.replace(/[=:]/g,function(ye){return W[ye]})}var ee=/\/+/g;function fe(L,W){return typeof L=="object"&&L!==null&&L.key!=null?P(""+L.key):W.toString(36)}function B(L,W,ye,j,le){var he=typeof L;(he==="undefined"||he==="boolean")&&(L=null);var Ae=!1;if(L===null)Ae=!0;else switch(he){case"string":case"number":Ae=!0;break;case"object":switch(L.$$typeof){case s:case e:Ae=!0}}if(Ae)return Ae=L,le=le(Ae),L=j===""?"."+fe(Ae,0):j,D(le)?(ye="",L!=null&&(ye=L.replace(ee,"$&/")+"/"),B(le,W,ye,"",function(be){return be})):le!=null&&(T(le)&&(le=ve(le,ye+(!le.key||Ae&&Ae.key===le.key?"":(""+le.key).replace(ee,"$&/")+"/")+L)),W.push(le)),1;if(Ae=0,j=j===""?".":j+":",D(L))for(var ce=0;ce<L.length;ce++){he=L[ce];var ae=j+fe(he,ce);Ae+=B(he,W,ye,ae,le)}else if(ae=y(L),typeof ae=="function")for(L=ae.call(L),ce=0;!(he=L.next()).done;)he=he.value,ae=j+fe(he,ce++),Ae+=B(he,W,ye,ae,le);else if(he==="object")throw W=String(L),Error("Objects are not valid as a React child (found: "+(W==="[object Object]"?"object with keys {"+Object.keys(L).join(", ")+"}":W)+"). If you meant to render a collection of children, use an array instead.");return Ae}function ne(L,W,ye){if(L==null)return L;var j=[],le=0;return B(L,j,"","",function(he){return W.call(ye,he,le++)}),j}function J(L){if(L._status===-1){var W=L._result;W=W(),W.then(function(ye){(L._status===0||L._status===-1)&&(L._status=1,L._result=ye)},function(ye){(L._status===0||L._status===-1)&&(L._status=2,L._result=ye)}),L._status===-1&&(L._status=0,L._result=W)}if(L._status===1)return L._result.default;throw L._result}var de={current:null},H={transition:null},$={ReactCurrentDispatcher:de,ReactCurrentBatchConfig:H,ReactCurrentOwner:z};function X(){throw Error("act(...) is not supported in production builds of React.")}return ht.Children={map:ne,forEach:function(L,W,ye){ne(L,function(){W.apply(this,arguments)},ye)},count:function(L){var W=0;return ne(L,function(){W++}),W},toArray:function(L){return ne(L,function(W){return W})||[]},only:function(L){if(!T(L))throw Error("React.Children.only expected to receive a single React element child.");return L}},ht.Component=v,ht.Fragment=n,ht.Profiler=a,ht.PureComponent=N,ht.StrictMode=r,ht.Suspense=h,ht.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=$,ht.act=X,ht.cloneElement=function(L,W,ye){if(L==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+L+".");var j=E({},L.props),le=L.key,he=L.ref,Ae=L._owner;if(W!=null){if(W.ref!==void 0&&(he=W.ref,Ae=z.current),W.key!==void 0&&(le=""+W.key),L.type&&L.type.defaultProps)var ce=L.type.defaultProps;for(ae in W)V.call(W,ae)&&!F.hasOwnProperty(ae)&&(j[ae]=W[ae]===void 0&&ce!==void 0?ce[ae]:W[ae])}var ae=arguments.length-2;if(ae===1)j.children=ye;else if(1<ae){ce=Array(ae);for(var be=0;be<ae;be++)ce[be]=arguments[be+2];j.children=ce}return{$$typeof:s,type:L.type,key:le,ref:he,props:j,_owner:Ae}},ht.createContext=function(L){return L={$$typeof:d,_currentValue:L,_currentValue2:L,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},L.Provider={$$typeof:l,_context:L},L.Consumer=L},ht.createElement=ue,ht.createFactory=function(L){var W=ue.bind(null,L);return W.type=L,W},ht.createRef=function(){return{current:null}},ht.forwardRef=function(L){return{$$typeof:u,render:L}},ht.isValidElement=T,ht.lazy=function(L){return{$$typeof:g,_payload:{_status:-1,_result:L},_init:J}},ht.memo=function(L,W){return{$$typeof:p,type:L,compare:W===void 0?null:W}},ht.startTransition=function(L){var W=H.transition;H.transition={};try{L()}finally{H.transition=W}},ht.unstable_act=X,ht.useCallback=function(L,W){return de.current.useCallback(L,W)},ht.useContext=function(L){return de.current.useContext(L)},ht.useDebugValue=function(){},ht.useDeferredValue=function(L){return de.current.useDeferredValue(L)},ht.useEffect=function(L,W){return de.current.useEffect(L,W)},ht.useId=function(){return de.current.useId()},ht.useImperativeHandle=function(L,W,ye){return de.current.useImperativeHandle(L,W,ye)},ht.useInsertionEffect=function(L,W){return de.current.useInsertionEffect(L,W)},ht.useLayoutEffect=function(L,W){return de.current.useLayoutEffect(L,W)},ht.useMemo=function(L,W){return de.current.useMemo(L,W)},ht.useReducer=function(L,W,ye){return de.current.useReducer(L,W,ye)},ht.useRef=function(L){return de.current.useRef(L)},ht.useState=function(L){return de.current.useState(L)},ht.useSyncExternalStore=function(L,W,ye){return de.current.useSyncExternalStore(L,W,ye)},ht.useTransition=function(){return de.current.useTransition()},ht.version="18.3.1",ht}var ep;function Ed(){return ep||(ep=1,Mu.exports=l0()),Mu.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ip;function d0(){return ip||(ip=1,(function(s){function e(H,$){var X=H.length;H.push($);e:for(;0<X;){var L=X-1>>>1,W=H[L];if(0<a(W,$))H[L]=$,H[X]=W,X=L;else break e}}function n(H){return H.length===0?null:H[0]}function r(H){if(H.length===0)return null;var $=H[0],X=H.pop();if(X!==$){H[0]=X;e:for(var L=0,W=H.length,ye=W>>>1;L<ye;){var j=2*(L+1)-1,le=H[j],he=j+1,Ae=H[he];if(0>a(le,X))he<W&&0>a(Ae,le)?(H[L]=Ae,H[he]=X,L=he):(H[L]=le,H[j]=X,L=j);else if(he<W&&0>a(Ae,X))H[L]=Ae,H[he]=X,L=he;else break e}}return $}function a(H,$){var X=H.sortIndex-$.sortIndex;return X!==0?X:H.id-$.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;s.unstable_now=function(){return l.now()}}else{var d=Date,u=d.now();s.unstable_now=function(){return d.now()-u}}var h=[],p=[],g=1,_=null,y=3,S=!1,E=!1,w=!1,v=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(H){for(var $=n(p);$!==null;){if($.callback===null)r(p);else if($.startTime<=H)r(p),$.sortIndex=$.expirationTime,e(h,$);else break;$=n(p)}}function D(H){if(w=!1,b(H),!E)if(n(h)!==null)E=!0,J(V);else{var $=n(p);$!==null&&de(D,$.startTime-H)}}function V(H,$){E=!1,w&&(w=!1,x(ue),ue=-1),S=!0;var X=y;try{for(b($),_=n(h);_!==null&&(!(_.expirationTime>$)||H&&!P());){var L=_.callback;if(typeof L=="function"){_.callback=null,y=_.priorityLevel;var W=L(_.expirationTime<=$);$=s.unstable_now(),typeof W=="function"?_.callback=W:_===n(h)&&r(h),b($)}else r(h);_=n(h)}if(_!==null)var ye=!0;else{var j=n(p);j!==null&&de(D,j.startTime-$),ye=!1}return ye}finally{_=null,y=X,S=!1}}var z=!1,F=null,ue=-1,ve=5,T=-1;function P(){return!(s.unstable_now()-T<ve)}function ee(){if(F!==null){var H=s.unstable_now();T=H;var $=!0;try{$=F(!0,H)}finally{$?fe():(z=!1,F=null)}}else z=!1}var fe;if(typeof N=="function")fe=function(){N(ee)};else if(typeof MessageChannel<"u"){var B=new MessageChannel,ne=B.port2;B.port1.onmessage=ee,fe=function(){ne.postMessage(null)}}else fe=function(){v(ee,0)};function J(H){F=H,z||(z=!0,fe())}function de(H,$){ue=v(function(){H(s.unstable_now())},$)}s.unstable_IdlePriority=5,s.unstable_ImmediatePriority=1,s.unstable_LowPriority=4,s.unstable_NormalPriority=3,s.unstable_Profiling=null,s.unstable_UserBlockingPriority=2,s.unstable_cancelCallback=function(H){H.callback=null},s.unstable_continueExecution=function(){E||S||(E=!0,J(V))},s.unstable_forceFrameRate=function(H){0>H||125<H?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ve=0<H?Math.floor(1e3/H):5},s.unstable_getCurrentPriorityLevel=function(){return y},s.unstable_getFirstCallbackNode=function(){return n(h)},s.unstable_next=function(H){switch(y){case 1:case 2:case 3:var $=3;break;default:$=y}var X=y;y=$;try{return H()}finally{y=X}},s.unstable_pauseExecution=function(){},s.unstable_requestPaint=function(){},s.unstable_runWithPriority=function(H,$){switch(H){case 1:case 2:case 3:case 4:case 5:break;default:H=3}var X=y;y=H;try{return $()}finally{y=X}},s.unstable_scheduleCallback=function(H,$,X){var L=s.unstable_now();switch(typeof X=="object"&&X!==null?(X=X.delay,X=typeof X=="number"&&0<X?L+X:L):X=L,H){case 1:var W=-1;break;case 2:W=250;break;case 5:W=1073741823;break;case 4:W=1e4;break;default:W=5e3}return W=X+W,H={id:g++,callback:$,priorityLevel:H,startTime:X,expirationTime:W,sortIndex:-1},X>L?(H.sortIndex=X,e(p,H),n(h)===null&&H===n(p)&&(w?(x(ue),ue=-1):w=!0,de(D,X-L))):(H.sortIndex=W,e(h,H),E||S||(E=!0,J(V))),H},s.unstable_shouldYield=P,s.unstable_wrapCallback=function(H){var $=y;return function(){var X=y;y=$;try{return H.apply(this,arguments)}finally{y=X}}}})(wu)),wu}var rp;function f0(){return rp||(rp=1,Tu.exports=d0()),Tu.exports}/**
 * @license React
...
`)+`
`+x,N=["precision mediump sampler2DArray;","#define varying in",n.glslVersion===Wp?"":"layout(location = 0) out highp vec4 pc_fragColor;",n.glslVersion===Wp?"":"#define gl_FragColor pc_fragColor","#define gl_FragDepthEXT gl_FragDepth","#define texture2D texture","#define textureCube texture","#define texture2DProj textureProj","#define texture2DLodEXT textureLod","#define texture2DProjLodEXT textureProjLod","#define textureCubeLodEXT textureLod","#define texture2DGradEXT textureGrad","#define texture2DProjGradEXT textureProjGrad","#define textureCubeGradEXT textureGrad"].join(`
`)+`
`+N);const D=b+x+d,V=b+N+u,z=Em(a,a.VERTEX_SHADER,D),F=Em(a,a.FRAGMENT_SHADER,V);a.attachShader(v,z),a.attachShader(v,F),n.index0AttributeName!==void 0?a.bindAttribLocation(v,0,n.index0AttributeName):n.morphTargets===!0&&a.bindAttribLocation(v,0,"position"),a.linkProgram(v);function ue(ee){if(s.debug.checkShaderErrors){const fe=a.getProgramInfoLog(v).trim(),B=a.getShaderInfoLog(z).trim(),ne=a.getShaderInfoLog(F).trim();let J=!0,de=!0;if(a.getProgramParameter(v,a.LINK_STATUS)===!1)if(J=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(a,v,z,F);else{const H=Tm(a,z,"vertex"),$=Tm(a,F,"fragment");console.error("THREE.WebGLProgram: Shader Error "+a.getError()+" - VALIDATE_STATUS "+a.getProgramParameter(v,a.VALIDATE_STATUS)+`
...
Program Info Log: `+fe+`
`+H+`
`+$)}else fe!==""?console.warn("THREE.WebGLProgram: Program Info Log:",fe):(B===""||ne==="")&&(de=!1);de&&(ee.diagnostics={runnable:J,programLog:fe,vertexShader:{log:B,prefix:x},fragmentShader:{log:ne,prefix:N}})}a.deleteShader(z),a.deleteShader(F),ve=new Pl(a,v),T=oE(a,v)}let ve;this.getUniforms=function(){return ve===void 0&&ue(this),ve};let T;this.getAttributes=function(){return T===void 0&&ue(this),T};let P=n.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return P===!1&&(P=a.getProgramParameter(v,ZM)),P},this.destroy=function(){r.releaseStatesOfProgram(this),a.deleteProgram(v),this.program=void 0},this.type=n.shaderType,this.name=n.shaderName,this.id=QM++,this.cacheKey=e,this.usedTimes=1,this.program=v,this.vertexShader=z,this.fragmentShader=F,this}let _E=0;class xE{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const n=e.vertexShader,r=e.fragmentShader,a=this._getShaderStage(n),l=this._getShaderStage(r),d=this._getShaderCacheForMaterial(e);return d.has(a)===!1&&(d.add(a),a.usedTimes++),d.has(l)===!1&&(d.add(l),l.usedTimes++),this}remove(e){const n=this.materialCache.get(e);for(const r of n)r.usedTimes--,r.usedTimes===0&&this.shaderCache.delete(r.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const n=this.materialCache;let r=n.get(e);return r===void 0&&(r=new Set,n.set(e,r)),r}_getShaderStage(e){const n=this.shaderCache;let r=n.get(e);return r===void 0&&(r=new yE(e),n.set(e,r)),r}}class yE{constructor(e){this.id=_E++,this.code=e,this.usedTimes=0}}function SE(s,e,n,r,a,l,d){const u=new ug,h=new xE,p=new Set,g=[],_=a.isWebGL2,y=a.logarithmicDepthBuffer,S=a.vertexTextures;let E=a.precision;const w={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function v(T){return p.add(T),T===0?"uv":`uv${T}`}function x(T,P,ee,fe,B){const ne=fe.fog,J=B.geometry,de=T.isMeshStandardMaterial?fe.environment:null,H=(T.isMeshStandardMaterial?n:e).get(T.envMap||de),$=H&&H.mapping===Ol?H.image.height:null,X=w[T.type];T.precision!==null&&(E=a.getMaxPrecision(T.precision),E!==T.precision&&console.warn("THREE.WebGLProgram.getParameters:",T.precision,"not supported, using",E,"instead."));const L=J.morphAttributes.position||J.morphAttributes.normal||J.morphAttributes.color,W=L!==void 0?L.length:0;let ye=0;J.morphAttributes.position!==void 0&&(ye=1),J.morphAttributes.normal!==void 0&&(ye=2),J.morphAttributes.color!==void 0&&(ye=3);let j,le,he,Ae;if(X){const At=yi[X];j=At.vertexShader,le=At.fragmentShader}else j=T.vertexShader,le=T.fragmentShader,h.update(T),he=h.getVertexShaderID(T),Ae=h.getFragmentShaderID(T);const ce=s.getRenderTarget(),ae=B.isInstancedMesh===!0,be=B.isBatchedMesh===!0,ze=!!T.map,q=!!T.matcap,mt=!!H,Ie=!!T.aoMap,je=!!T.lightMap,Ne=!!T.bumpMap,tt=!!T.normalMap,Ye=!!T.displacementMap,R=!!T.emissiveMap,A=!!T.metalnessMap,te=!!T.roughnessMap,Se=T.anisotropy>0,_e=T.clearcoat>0,Me=T.iridescence>0,Ge=T.sheen>0,Ce=T.transmission>0,Fe=Se&&!!T.anisotropyMap,Ke=_e&&!!T.clearcoatMap,at=_e&&!!T.clearcoatNormalMap,ge=_e&&!!T.clearcoatRoughnessMap,gt=Me&&!!T.iridescenceMap,ft=Me&&!!T.iridescenceThicknessMap,it=Ge&&!!T.sheenColorMap,qe=Ge&&!!T.sheenRoughnessMap,ke=!!T.specularMap,st=!!T.specularColorMap,_t=!!T.specularIntensityMap,wt=Ce&&!!T.transmissionMap,ct=Ce&&!!T.thicknessMap,Et=!!T.gradientMap,I=!!T.alphaMap,Ee=T.alphaTest>0,we=!!T.alphaHash,He=!!T.extensions;let $e=Mr;T.toneMapped&&(ce===null||ce.isXRRenderTarget===!0)&&($e=s.toneMapping);const yt={isWebGL2:_,shaderID:X,shaderType:T.type,shaderName:T.name,vertexShader:j,fragmentShader:le,defines:T.defines,customVertexShaderID:he,customFragmentShaderID:Ae,isRawShaderMaterial:T.isRawShaderMaterial===!0,glslVersion:T.glslVersion,precision:E,batching:be,instancing:ae,instancingColor:ae&&B.instanceColor!==null,supportsVertexTextures:S,outputColorSpace:ce===null?s.outputColorSpace:ce.isXRRenderTarget===!0?ce.texture.colorSpace:Xi,alphaToCoverage:!!T.alphaToCoverage,map:ze,matcap:q,envMap:mt,envMapMode:mt&&H.mapping,envMapCubeUVHeight:$,aoMap:Ie,lightMap:je,bumpMap:Ne,normalMap:tt,displacementMap:S&&Ye,emissiveMap:R,normalMapObjectSpace:tt&&T.normalMapType===b_,normalMapTangentSpace:tt&&T.normalMapType===C_,metalnessMap:A,roughnessMap:te,anisotropy:Se,anisotropyMap:Fe,clearcoat:_e,clearcoatMap:Ke,clearcoatNormalMap:at,clearcoatRoughnessMap:ge,iridescence:Me,iridescenceMap:gt,iridescenceThicknessMap:ft,sheen:Ge,sheenColorMap:it,sheenRoughnessMap:qe,specularMap:ke,specularColorMap:st,specularIntensityMap:_t,transmission:Ce,transmissionMap:wt,thicknessMap:ct,gradientMap:Et,opaque:T.transparent===!1&&T.blending===Vs&&T.alphaToCoverage===!1,alphaMap:I,alphaTest:Ee,alphaHash:we,combine:T.combine,mapUv:ze&&v(T.map.channel),aoMapUv:Ie&&v(T.aoMap.channel),lightMapUv:je&&v(T.lightMap.channel),bumpMapUv:Ne&&v(T.bumpMap.channel),normalMapUv:tt&&v(T.normalMap.channel),displacementMapUv:Ye&&v(T.displacementMap.channel),emissiveMapUv:R&&v(T.emissiveMap.channel),metalnessMapUv:A&&v(T.metalnessMap.channel),roughnessMapUv:te&&v(T.roughnessMap.channel),anisotropyMapUv:Fe&&v(T.anisotropyMap.channel),clearcoatMapUv:Ke&&v(T.clearcoatMap.channel),clearcoatNormalMapUv:at&&v(T.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:ge&&v(T.clearcoatRoughnessMap.channel),iridescenceMapUv:gt&&v(T.iridescenceMap.channel),iridescenceThicknessMapUv:ft&&v(T.iridescenceThicknessMap.channel),sheenColorMapUv:it&&v(T.sheenColorMap.channel),sheenRoughnessMapUv:qe&&v(T.sheenRoughnessMap.channel),specularMapUv:ke&&v(T.specularMap.channel),specularColorMapUv:st&&v(T.specularColorMap.channel),specularIntensityMapUv:_t&&v(T.specularIntensityMap.channel),transmissionMapUv:wt&&v(T.transmissionMap.channel),thicknessMapUv:ct&&v(T.thicknessMap.channel),alphaMapUv:I&&v(T.alphaMap.channel),vertexTangents:!!J.attributes.tangent&&(tt||Se),vertexColors:T.vertexColors,vertexAlphas:T.vertexColors===!0&&!!J.attributes.color&&J.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!J.attributes.uv&&(ze||I),fog:!!ne,useFog:T.fog===!0,fogExp2:!!ne&&ne.isFogExp2,flatShading:T.flatShading===!0,sizeAttenuation:T.sizeAttenuation===!0,logarithmicDepthBuffer:y,skinning:B.isSkinnedMesh===!0,morphTargets:J.morphAttributes.position!==void 0,morphNormals:J.morphAttributes.normal!==void 0,morphColors:J.morphAttributes.color!==void 0,morphTargetsCount:W,morphTextureStride:ye,numDirLights:P.directional.length,numPointLights:P.point.length,numSpotLights:P.spot.length,numSpotLightMaps:P.spotLightMap.length,numRectAreaLights:P.rectArea.length,numHemiLights:P.hemi.length,numDirLightShadows:P.directionalShadowMap.length,numPointLightShadows:P.pointShadowMap.length,numSpotLightShadows:P.spotShadowMap.length,numSpotLightShadowsWithMaps:P.numSpotLightShadowsWithMaps,numLightProbes:P.numLightProbes,numClippingPlanes:d.numPlanes,numClipIntersection:d.numIntersection,dithering:T.dithering,shadowMapEnabled:s.shadowMap.enabled&&ee.length>0,shadowMapType:s.shadowMap.type,toneMapping:$e,useLegacyLights:s._useLegacyLights,decodeVideoTexture:ze&&T.map.isVideoTexture===!0&&Ct.getTransfer(T.map.colorSpace)===Nt,premultipliedAlpha:T.premultipliedAlpha,doubleSided:T.side===Bi,flipSided:T.side===Un,useDepthPacking:T.depthPacking>=0,depthPacking:T.depthPacking||0,index0AttributeName:T.index0AttributeName,extensionDerivatives:He&&T.extensions.derivatives===!0,extensionFragDepth:He&&T.extensions.fragDepth===!0,extensionDrawBuffers:He&&T.extensions.drawBuffers===!0,extensionShaderTextureLOD:He&&T.extensions.shaderTextureLOD===!0,extensionClipCullDistance:He&&T.extensions.clipCullDistance===!0&&r.has("WEBGL_clip_cull_distance"),extensionMultiDraw:He&&T.extensions.multiDraw===!0&&r.has("WEBGL_multi_draw"),rendererExtensionFragDepth:_||r.has("EXT_frag_depth"),rendererExtensionDrawBuffers:_||r.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:_||r.has("EXT_shader_texture_lod"),rendererExtensionParallelShaderCompile:r.has("KHR_parallel_shader_compile"),customProgramCacheKey:T.customProgramCacheKey()};return yt.vertexUv1s=p.has(1),yt.vertexUv2s=p.has(2),yt.vertexUv3s=p.has(3),p.clear(),yt}function N(T){const P=[];if(T.shaderID?P.push(T.shaderID):(P.push(T.customVertexShaderID),P.push(T.customFragmentShaderID)),T.defines!==void 0)for(const ee in T.defines)P.push(ee),P.push(T.defines[ee]);return T.isRawShaderMaterial===!1&&(b(P,T),D(P,T),P.push(s.outputColorSpace)),P.push(T.customProgramCacheKey),P.join()}function b(T,P){T.push(P.precision),T.push(P.outputColorSpace),T.push(P.envMapMode),T.push(P.envMapCubeUVHeight),T.push(P.mapUv),T.push(P.alphaMapUv),T.push(P.lightMapUv),T.push(P.aoMapUv),T.push(P.bumpMapUv),T.push(P.normalMapUv),T.push(P.displacementMapUv),T.push(P.emissiveMapUv),T.push(P.metalnessMapUv),T.push(P.roughnessMapUv),T.push(P.anisotropyMapUv),T.push(P.clearcoatMapUv),T.push(P.clearcoatNormalMapUv),T.push(P.clearcoatRoughnessMapUv),T.push(P.iridescenceMapUv),T.push(P.iridescenceThicknessMapUv),T.push(P.sheenColorMapUv),T.push(P.sheenRoughnessMapUv),T.push(P.specularMapUv),T.push(P.specularColorMapUv),T.push(P.specularIntensityMapUv),T.push(P.transmissionMapUv),T.push(P.thicknessMapUv),T.push(P.combine),T.push(P.fogExp2),T.push(P.sizeAttenuation),T.push(P.morphTargetsCount),T.push(P.morphAttributeCount),T.push(P.numDirLights),T.push(P.numPointLights),T.push(P.numSpotLights),T.push(P.numSpotLightMaps),T.push(P.numHemiLights),T.push(P.numRectAreaLights),T.push(P.numDirLightShadows),T.push(P.numPointLightShadows),T.push(P.numSpotLightShadows),T.push(P.numSpotLightShadowsWithMaps),T.push(P.numLightProbes),T.push(P.shadowMapType),T.push(P.toneMapping),T.push(P.numClippingPlanes),T.push(P.numClipIntersection),T.push(P.depthPacking)}function D(T,P){u.disableAll(),P.isWebGL2&&u.enable(0),P.supportsVertexTextures&&u.enable(1),P.instancing&&u.enable(2),P.instancingColor&&u.enable(3),P.matcap&&u.enable(4),P.envMap&&u.enable(5),P.normalMapObjectSpace&&u.enable(6),P.normalMapTangentSpace&&u.enable(7),P.clearcoat&&u.enable(8),P.iridescence&&u.enable(9),P.alphaTest&&u.enable(10),P.vertexColors&&u.enable(11),P.vertexAlphas&&u.enable(12),P.vertexUv1s&&u.enable(13),P.vertexUv2s&&u.enable(14),P.vertexUv3s&&u.enable(15),P.vertexTangents&&u.enable(16),P.anisotropy&&u.enable(17),P.alphaHash&&u.enable(18),P.batching&&u.enable(19),T.push(u.mask),u.disableAll(),P.fog&&u.enable(0),P.useFog&&u.enable(1),P.flatShading&&u.enable(2),P.logarithmicDepthBuffer&&u.enable(3),P.skinning&&u.enable(4),P.morphTargets&&u.enable(5),P.morphNormals&&u.enable(6),P.morphColors&&u.enable(7),P.premultipliedAlpha&&u.enable(8),P.shadowMapEnabled&&u.enable(9),P.useLegacyLights&&u.enable(10),P.doubleSided&&u.enable(11),P.flipSided&&u.enable(12),P.useDepthPacking&&u.enable(13),P.dithering&&u.enable(14),P.transmission&&u.enable(15),P.sheen&&u.enable(16),P.opaque&&u.enable(17),P.pointsUvs&&u.enable(18),P.decodeVideoTexture&&u.enable(19),P.alphaToCoverage&&u.enable(20),T.push(u.mask)}function V(T){const P=w[T.type];let ee;if(P){const fe=yi[P];ee=nx.clone(fe.uniforms)}else ee=T.uniforms;return ee}function z(T,P){let ee;for(let fe=0,B=g.length;fe<B;fe++){const ne=g[fe];if(ne.cacheKey===P){ee=ne,++ee.usedTimes;break}}return ee===void 0&&(ee=new vE(s,P,T,l),g.push(ee)),ee}function F(T){if(--T.usedTimes===0){const P=g.indexOf(T);g[P]=g[g.length-1],g.pop(),T.destroy()}}function ue(T){h.remove(T)}function ve(){h.dispose()}return{getParameters:x,getProgramCacheKey:N,getUniforms:V,acquireProgram:z,releaseProgram:F,releaseShaderCache:ue,programs:g,dispose:ve}}function ME(){let s=new WeakMap;function e(l){let d=s.get(l);return d===void 0&&(d={},s.set(l,d)),d}function n(l){s.delete(l)}function r(l,d,u){s.get(l)[d]=u}function a(){s=new WeakMap}return{get:e,remove:n,update:r,dispose:a}}function EE(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.material.id!==e.material.id?s.material.id-e.material.id:s.z!==e.z?s.z-e.z:s.id-e.id}function bm(s,e){return s.groupOrder!==e.groupOrder?s.groupOrder-e.groupOrder:s.renderOrder!==e.renderOrder?s.renderOrder-e.renderOrder:s.z!==e.z?e.z-s.z:s.id-e.id}function Pm(){const s=[];let e=0;const n=[],r=[],a=[];function l(){e=0,n.length=0,r.length=0,a.length=0}function d(_,y,S,E,w,v){let x=s[e];return x===void 0?(x={id:_.id,object:_,geometry:y,material:S,groupOrder:E,renderOrder:_.renderOrder,z:w,group:v},s[e]=x):(x.id=_.id,x.object=_,x.geometry=y,x.material=S,x.groupOrder=E,x.renderOrder=_.renderOrder,x.z=w,x.group=v),e++,x}function u(_,y,S,E,w,v){const x=d(_,y,S,E,w,v);S.transmission>0?r.push(x):S.transparent===!0?a.push(x):n.push(x)}function h(_,y,S,E,w,v){const x=d(_,y,S,E,w,v);S.transmission>0?r.unshift(x):S.transparent===!0?a.unshift(x):n.unshift(x)}function p(_,y){n.length>1&&n.sort(_||EE),r.length>1&&r.sort(y||bm),a.length>1&&a.sort(y||bm)}function g(){for(let _=e,y=s.length;_<y;_++){const S=s[_];if(S.id===null)break;S.id=null,S.object=null,S.geometry=null,S.material=null,S.group=null}}return{opaque:n,transmissive:r,transparent:a,init:l,push:u,unshift:h,finish:g,sort:p}}function TE(){let s=new WeakMap;function e(r,a){const l=s.get(r);let d;return l===void 0?(d=new Pm,s.set(r,[d])):a>=l.length?(d=new Pm,l.push(d)):d=l[a],d}function n(){s=new WeakMap}return{get:e,dispose:n}}function wE(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let n;switch(e.type){case"DirectionalLight":n={direction:new Y,color:new We};break;case"SpotLight":n={position:new Y,direction:new Y,color:new We,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":n={position:new Y,color:new We,distance:0,decay:0};break;case"HemisphereLight":n={direction:new Y,skyColor:new We,groundColor:new We};break;case"RectAreaLight":n={color:new We,position:new Y,halfWidth:new Y,halfHeight:new Y};break}return s[e.id]=n,n}}}function AE(){const s={};return{get:function(e){if(s[e.id]!==void 0)return s[e.id];let n;switch(e.type){case"DirectionalLight":n={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Tt};break;case"SpotLight":n={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Tt};break;case"PointLight":n={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Tt,shadowCameraNear:1,shadowCameraFar:1e3};break}return s[e.id]=n,n}}}let RE=0;function CE(s,e){return(e.castShadow?2:0)-(s.castShadow?2:0)+(e.map?1:0)-(s.map?1:0)}function bE(s,e){const n=new wE,r=AE(),a={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let g=0;g<9;g++)a.probe.push(new Y);const l=new Y,d=new Yt,u=new Yt;function h(g,_){let y=0,S=0,E=0;for(let ee=0;ee<9;ee++)a.probe[ee].set(0,0,0);let w=0,v=0,x=0,N=0,b=0,D=0,V=0,z=0,F=0,ue=0,ve=0;g.sort(CE);const T=_===!0?Math.PI:1;for(let ee=0,fe=g.length;ee<fe;ee++){const B=g[ee],ne=B.color,J=B.intensity,de=B.distance,H=B.shadow&&B.shadow.map?B.shadow.map.texture:null;if(B.isAmbientLight)y+=ne.r*J*T,S+=ne.g*J*T,E+=ne.b*J*T;else if(B.isLightProbe){for(let $=0;$<9;$++)a.probe[$].addScaledVector(B.sh.coefficients[$],J);ve++}else if(B.isDirectionalLight){const $=n.get(B);if($.color.copy(B.color).multiplyScalar(B.intensity*T),B.castShadow){const X=B.shadow,L=r.get(B);L.shadowBias=X.bias,L.shadowNormalBias=X.normalBias,L.shadowRadius=X.radius,L.shadowMapSize=X.mapSize,a.directionalShadow[w]=L,a.directionalShadowMap[w]=H,a.directionalShadowMatrix[w]=B.shadow.matrix,D++}a.directional[w]=$,w++}else if(B.isSpotLight){const $=n.get(B);$.position.setFromMatrixPosition(B.matrixWorld),$.color.copy(ne).multiplyScalar(J*T),$.distance=de,$.coneCos=Math.cos(B.angle),$.penumbraCos=Math.cos(B.angle*(1-B.penumbra)),$.decay=B.decay,a.spot[x]=$;const X=B.shadow;if(B.map&&(a.spotLightMap[F]=B.map,F++,X.updateMatrices(B),B.castShadow&&ue++),a.spotLightMatrix[x]=X.matrix,B.castShadow){const L=r.get(B);L.shadowBias=X.bias,L.shadowNormalBias=X.normalBias,L.shadowRadius=X.radius,L.shadowMapSize=X.mapSize,a.spotShadow[x]=L,a.spotShadowMap[x]=H,z++}x++}else if(B.isRectAreaLight){const $=n.get(B);$.color.copy(ne).multiplyScalar(J),$.halfWidth.set(B.width*.5,0,0),$.halfHeight.set(0,B.height*.5,0),a.rectArea[N]=$,N++}else if(B.isPointLight){const $=n.get(B);if($.color.copy(B.color).multiplyScalar(B.intensity*T),$.distance=B.distance,$.decay=B.decay,B.castShadow){const X=B.shadow,L=r.get(B);L.shadowBias=X.bias,L.shadowNormalBias=X.normalBias,L.shadowRadius=X.radius,L.shadowMapSize=X.mapSize,L.shadowCameraNear=X.camera.near,L.shadowCameraFar=X.camera.far,a.pointShadow[v]=L,a.pointShadowMap[v]=H,a.pointShadowMatrix[v]=B.shadow.matrix,V++}a.point[v]=$,v++}else if(B.isHemisphereLight){const $=n.get(B);$.skyColor.copy(B.color).multiplyScalar(J*T),$.groundColor.copy(B.groundColor).multiplyScalar(J*T),a.hemi[b]=$,b++}}N>0&&(e.isWebGL2?s.has("OES_texture_float_linear")===!0?(a.rectAreaLTC1=Re.LTC_FLOAT_1,a.rectAreaLTC2=Re.LTC_FLOAT_2):(a.rectAreaLTC1=Re.LTC_HALF_1,a.rectAreaLTC2=Re.LTC_HALF_2):s.has("OES_texture_float_linear")===!0?(a.rectAreaLTC1=Re.LTC_FLOAT_1,a.rectAreaLTC2=Re.LTC_FLOAT_2):s.has("OES_texture_half_float_linear")===!0?(a.rectAreaLTC1=Re.LTC_HALF_1,a.rectAreaLTC2=Re.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),a.ambient[0]=y,a.ambient[1]=S,a.ambient[2]=E;const P=a.hash;(P.directionalLength!==w||P.pointLength!==v||P.spotLength!==x||P.rectAreaLength!==N||P.hemiLength!==b||P.numDirectionalShadows!==D||P.numPointShadows!==V||P.numSpotShadows!==z||P.numSpotMaps!==F||P.numLightProbes!==ve)&&(a.directional.length=w,a.spot.length=x,a.rectArea.length=N,a.point.length=v,a.hemi.length=b,a.directionalShadow.length=D,a.directionalShadowMap.length=D,a.pointShadow.length=V,a.pointShadowMap.length=V,a.spotShadow.length=z,a.spotShadowMap.length=z,a.directionalShadowMatrix.length=D,a.pointShadowMatrix.length=V,a.spotLightMatrix.length=z+F-ue,a.spotLightMap.length=F,a.numSpotLightShadowsWithMaps=ue,a.numLightProbes=ve,P.directionalLength=w,P.pointLength=v,P.spotLength=x,P.rectAreaLength=N,P.hemiLength=b,P.numDirectionalShadows=D,P.numPointShadows=V,P.numSpotShadows=z,P.numSpotMaps=F,P.numLightProbes=ve,a.version=RE++)}function p(g,_){let y=0,S=0,E=0,w=0,v=0;const x=_.matrixWorldInverse;for(let N=0,b=g.length;N<b;N++){const D=g[N];if(D.isDirectionalLight){const V=a.directional[y];V.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),V.direction.sub(l),V.direction.transformDirection(x),y++}else if(D.isSpotLight){const V=a.spot[E];V.position.setFromMatrixPosition(D.matrixWorld),V.position.applyMatrix4(x),V.direction.setFromMatrixPosition(D.matrixWorld),l.setFromMatrixPosition(D.target.matrixWorld),V.direction.sub(l),V.direction.transformDirection(x),E++}else if(D.isRectAreaLight){const V=a.rectArea[w];V.position.setFromMatrixPosition(D.matrixWorld),V.position.applyMatrix4(x),u.identity(),d.copy(D.matrixWorld),d.premultiply(x),u.extractRotation(d),V.halfWidth.set(D.width*.5,0,0),V.halfHeight.set(0,D.height*.5,0),V.halfWidth.applyMatrix4(u),V.halfHeight.applyMatrix4(u),w++}else if(D.isPointLight){const V=a.point[S];V.position.setFromMatrixPosition(D.matrixWorld),V.position.applyMatrix4(x),S++}else if(D.isHemisphereLight){const V=a.hemi[v];V.direction.setFromMatrixPosition(D.matrixWorld),V.direction.transformDirection(x),v++}}}return{setup:h,setupView:p,state:a}}function Lm(s,e){const n=new bE(s,e),r=[],a=[];function l(){r.length=0,a.length=0}function d(_){r.push(_)}function u(_){a.push(_)}function h(_){n.setup(r,_)}function p(_){n.setupView(r,_)}return{init:l,state:{lightsArray:r,shadowsArray:a,lights:n},setupLights:h,setupLightsView:p,pushLight:d,pushShadow:u}}function PE(s,e){let n=new WeakMap;function r(l,d=0){const u=n.get(l);let h;return u===void 0?(h=new Lm(s,e),n.set(l,[h])):d>=u.length?(h=new Lm(s,e),u.push(h)):h=u[d],h}function a(){n=new WeakMap}return{get:r,dispose:a}}class LE extends jo{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=A_,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class DE extends jo{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const NE=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function IE(s,e,n){let r=new _g;const a=new Tt,l=new Tt,d=new sn,u=new LE({depthPacking:R_}),h=new DE,p={},g=n.maxTextureSize,_={[Tr]:Un,[Un]:Tr,[Bi]:Bi},y=new Mi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Tt},radius:{value:4}},vertexShader:NE,fragmentShader:UE}),S=y.clone();S.defines.HORIZONTAL_PASS=1;const E=new di;E.setAttribute("position",new ui(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new Wi(E,y),v=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=jm;let x=this.type;this.render=function(z,F,ue){if(v.enabled===!1||v.autoUpdate===!1&&v.needsUpdate===!1||z.length===0)return;const ve=s.getRenderTarget(),T=s.getActiveCubeFace(),P=s.getActiveMipmapLevel(),ee=s.state;ee.setBlending(Sr),ee.buffers.color.setClear(1,1,1,1),ee.buffers.depth.setTest(!0),ee.setScissorTest(!1);const fe=x!==ki&&this.type===ki,B=x===ki&&this.type!==ki;for(let ne=0,J=z.length;ne<J;ne++){const de=z[ne],H=de.shadow;if(H===void 0){console.warn("THREE.WebGLShadowMap:",de,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;a.copy(H.mapSize);const $=H.getFrameExtents();if(a.multiply($),l.copy(H.mapSize),(a.x>g||a.y>g)&&(a.x>g&&(l.x=Math.floor(g/$.x),a.x=l.x*$.x,H.mapSize.x=l.x),a.y>g&&(l.y=Math.floor(g/$.y),a.y=l.y*$.y,H.mapSize.y=l.y)),H.map===null||fe===!0||B===!0){const L=this.type!==ki?{minFilter:Sn,magFilter:Sn}:{};H.map!==null&&H.map.dispose(),H.map=new Jr(a.x,a.y,L),H.map.texture.name=de.name+".shadowMap",H.camera.updateProjectionMatrix()}s.setRenderTarget(H.map),s.clear();const X=H.getViewportCount();for(let L=0;L<X;L++){const W=H.getViewport(L);d.set(l.x*W.x,l.y*W.y,l.x*W.z,l.y*W.w),ee.viewport(d),H.updateMatrices(de,L),r=H.getFrustum(),D(F,ue,H.camera,de,this.type)}H.isPointLightShadow!==!0&&this.type===ki&&N(H,ue),H.needsUpdate=!1}x=this.type,v.needsUpdate=!1,s.setRenderTarget(ve,T,P)};function N(z,F){const ue=e.update(w);y.defines.VSM_SAMPLES!==z.blurSamples&&(y.defines.VSM_SAMPLES=z.blurSamples,S.defines.VSM_SAMPLES=z.blurSamples,y.needsUpdate=!0,S.needsUpdate=!0),z.mapPass===null&&(z.mapPass=new Jr(a.x,a.y)),y.uniforms.shadow_pass.value=z.map.texture,y.uniforms.resolution.value=z.mapSize,y.uniforms.radius.value=z.radius,s.setRenderTarget(z.mapPass),s.clear(),s.renderBufferDirect(F,null,ue,y,w,null),S.uniforms.shadow_pass.value=z.mapPass.texture,S.uniforms.resolution.value=z.mapSize,S.uniforms.radius.value=z.radius,s.setRenderTarget(z.map),s.clear(),s.renderBufferDirect(F,null,ue,S,w,null)}function b(z,F,ue,ve){let T=null;const P=ue.isPointLight===!0?z.customDistanceMaterial:z.customDepthMaterial;if(P!==void 0)T=P;else if(T=ue.isPointLight===!0?h:u,s.localClippingEnabled&&F.clipShadows===!0&&Array.isArray(F.clippingPlanes)&&F.clippingPlanes.length!==0||F.displacementMap&&F.displacementScale!==0||F.alphaMap&&F.alphaTest>0||F.map&&F.alphaTest>0){const ee=T.uuid,fe=F.uuid;let B=p[ee];B===void 0&&(B={},p[ee]=B);let ne=B[fe];ne===void 0&&(ne=T.clone(),B[fe]=ne,F.addEventListener("dispose",V)),T=ne}if(T.visible=F.visible,T.wireframe=F.wireframe,ve===ki?T.side=F.shadowSide!==null?F.shadowSide:F.side:T.side=F.shadowSide!==null?F.shadowSide:_[F.side],T.alphaMap=F.alphaMap,T.alphaTest=F.alphaTest,T.map=F.map,T.clipShadows=F.clipShadows,T.clippingPlanes=F.clippingPlanes,T.clipIntersection=F.clipIntersection,T.displacementMap=F.displacementMap,T.displacementScale=F.displacementScale,T.displacementBias=F.displacementBias,T.wireframeLinewidth=F.wireframeLinewidth,T.linewidth=F.linewidth,ue.isPointLight===!0&&T.isMeshDistanceMaterial===!0){const ee=s.properties.get(T);ee.light=ue}return T}function D(z,F,ue,ve,T){if(z.visible===!1)return;if(z.layers.test(F.layers)&&(z.isMesh||z.isLine||z.isPoints)&&(z.castShadow||z.receiveShadow&&T===ki)&&(!z.frustumCulled||r.intersectsObject(z))){z.modelViewMatrix.multiplyMatrices(ue.matrixWorldInverse,z.matrixWorld);const fe=e.update(z),B=z.material;if(Array.isArray(B)){const ne=fe.groups;for(let J=0,de=ne.length;J<de;J++){const H=ne[J],$=B[H.materialIndex];if($&&$.visible){const X=b(z,$,ve,T);z.onBeforeShadow(s,z,F,ue,fe,X,H),s.renderBufferDirect(ue,null,fe,X,z,H),z.onAfterShadow(s,z,F,ue,fe,X,H)}}}else if(B.visible){const ne=b(z,B,ve,T);z.onBeforeShadow(s,z,F,ue,fe,ne,null),s.renderBufferDirect(ue,null,fe,ne,z,null),z.onAfterShadow(s,z,F,ue,fe,ne,null)}}const ee=z.children;for(let fe=0,B=ee.length;fe<B;fe++)D(ee[fe],F,ue,ve,T)}function V(z){z.target.removeEventListener("dispose",V);for(const ue in p){const ve=p[ue],T=z.target.uuid;T in ve&&(ve[T].dispose(),delete ve[T])}}}function FE(s,e,n){const r=n.isWebGL2;function a(){let I=!1;const Ee=new sn;let we=null;const He=new sn(0,0,0,0);return{setMask:function($e){we!==$e&&!I&&(s.colorMask($e,$e,$e,$e),we=$e)},setLocked:function($e){I=$e},setClear:function($e,yt,At,Bt,mn){mn===!0&&($e*=Bt,yt*=Bt,At*=Bt),Ee.set($e,yt,At,Bt),He.equals(Ee)===!1&&(s.clearColor($e,yt,At,Bt),He.copy(Ee))},reset:function(){I=!1,we=null,He.set(-1,0,0,0)}}}function l(){let I=!1,Ee=null,we=null,He=null;return{setTest:function($e){$e?ae(s.DEPTH_TEST):be(s.DEPTH_TEST)},setMask:function($e){Ee!==$e&&!I&&(s.depthMask($e),Ee=$e)},setFunc:function($e){if(we!==$e){switch($e){case r_:s.depthFunc(s.NEVER);break;case s_:s.depthFunc(s.ALWAYS);break;case o_:s.depthFunc(s.LESS);break;case Ll:s.depthFunc(s.LEQUAL);break;case a_:s.depthFunc(s.EQUAL);break;case l_:s.depthFunc(s.GEQUAL);break;case c_:s.depthFunc(s.GREATER);break;case u_:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}we=$e}},setLocked:function($e){I=$e},setClear:function($e){He!==$e&&(s.clearDepth($e),He=$e)},reset:function(){I=!1,Ee=null,we=null,He=null}}}function d(){let I=!1,Ee=null,we=null,He=null,$e=null,yt=null,At=null,Bt=null,mn=null;return{setTest:function(St){I||(St?ae(s.STENCIL_TEST):be(s.STENCIL_TEST))},setMask:function(St){Ee!==St&&!I&&(s.stencilMask(St),Ee=St)},setFunc:function(St,Xt,on){(we!==St||He!==Xt||$e!==on)&&(s.stencilFunc(St,Xt,on),we=St,He=Xt,$e=on)},setOp:function(St,Xt,on){(yt!==St||At!==Xt||Bt!==on)&&(s.stencilOp(St,Xt,on),yt=St,At=Xt,Bt=on)},setLocked:function(St){I=St},setClear:function(St){mn!==St&&(s.clearStencil(St),mn=St)},reset:function(){I=!1,Ee=null,we=null,He=null,$e=null,yt=null,At=null,Bt=null,mn=null}}}const u=new a,h=new l,p=new d,g=new WeakMap,_=new WeakMap;let y={},S={},E=new WeakMap,w=[],v=null,x=!1,N=null,b=null,D=null,V=null,z=null,F=null,ue=null,ve=new We(0,0,0),T=0,P=!1,ee=null,fe=null,B=null,ne=null,J=null;const de=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let H=!1,$=0;const X=s.getParameter(s.VERSION);X.indexOf("WebGL")!==-1?($=parseFloat(/^WebGL (\d)/.exec(X)[1]),H=$>=1):X.indexOf("OpenGL ES")!==-1&&($=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),H=$>=2);let L=null,W={};const ye=s.getParameter(s.SCISSOR_BOX),j=s.getParameter(s.VIEWPORT),le=new sn().fromArray(ye),he=new sn().fromArray(j);function Ae(I,Ee,we,He){const $e=new Uint8Array(4),yt=s.createTexture();s.bindTexture(I,yt),s.texParameteri(I,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(I,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let At=0;At<we;At++)r&&(I===s.TEXTURE_3D||I===s.TEXTURE_2D_ARRAY)?s.texImage3D(Ee,0,s.RGBA,1,1,He,0,s.RGBA,s.UNSIGNED_BYTE,$e):s.texImage2D(Ee+At,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,$e);return yt}const ce={};ce[s.TEXTURE_2D]=Ae(s.TEXTURE_2D,s.TEXTURE_2D,1),ce[s.TEXTURE_CUBE_MAP]=Ae(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),r&&(ce[s.TEXTURE_2D_ARRAY]=Ae(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),ce[s.TEXTURE_3D]=Ae(s.TEXTURE_3D,s.TEXTURE_3D,1,1)),u.setClear(0,0,0,1),h.setClear(1),p.setClear(0),ae(s.DEPTH_TEST),h.setFunc(Ll),Ye(!1),R(dp),ae(s.CULL_FACE),Ne(Sr);function ae(I){y[I]!==!0&&(s.enable(I),y[I]=!0)}function be(I){y[I]!==!1&&(s.disable(I),y[I]=!1)}function ze(I,Ee){return S[I]!==Ee?(s.bindFramebuffer(I,Ee),S[I]=Ee,r&&(I===s.DRAW_FRAMEBUFFER&&(S[s.FRAMEBUFFER]=Ee),I===s.FRAMEBUFFER&&(S[s.DRAW_FRAMEBUFFER]=Ee)),!0):!1}function q(I,Ee){let we=w,He=!1;if(I)if(we=E.get(Ee),we===void 0&&(we=[],E.set(Ee,we)),I.isWebGLMultipleRenderTargets){const $e=I.texture;if(we.length!==$e.length||we[0]!==s.COLOR_ATTACHMENT0){for(let yt=0,At=$e.length;yt<At;yt++)we[yt]=s.COLOR_ATTACHMENT0+yt;we.length=$e.length,He=!0}}else we[0]!==s.COLOR_ATTACHMENT0&&(we[0]=s.COLOR_ATTACHMENT0,He=!0);else we[0]!==s.BACK&&(we[0]=s.BACK,He=!0);He&&(n.isWebGL2?s.drawBuffers(we):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(we))}function mt(I){return v!==I?(s.useProgram(I),v=I,!0):!1}const Ie={[qr]:s.FUNC_ADD,[V0]:s.FUNC_SUBTRACT,[W0]:s.FUNC_REVERSE_SUBTRACT};if(r)Ie[pp]=s.MIN,Ie[mp]=s.MAX;else{const I=e.get("EXT_blend_minmax");I!==null&&(Ie[pp]=I.MIN_EXT,Ie[mp]=I.MAX_EXT)}const je={[X0]:s.ZERO,[j0]:s.ONE,[q0]:s.SRC_COLOR,[ud]:s.SRC_ALPHA,[J0]:s.SRC_ALPHA_SATURATE,[Z0]:s.DST_COLOR,[$0]:s.DST_ALPHA,[Y0]:s.ONE_MINUS_SRC_COLOR,[dd]:s.ONE_MINUS_SRC_ALPHA,[Q0]:s.ONE_MINUS_DST_COLOR,[K0]:s.ONE_MINUS_DST_ALPHA,[e_]:s.CONSTANT_COLOR,[t_]:s.ONE_MINUS_CONSTANT_COLOR,[n_]:s.CONSTANT_ALPHA,[i_]:s.ONE_MINUS_CONSTANT_ALPHA};function Ne(I,Ee,we,He,$e,yt,At,Bt,mn,St){if(I===Sr){x===!0&&(be(s.BLEND),x=!1);return}if(x===!1&&(ae(s.BLEND),x=!0),I!==G0){if(I!==N||St!==P){if((b!==qr||z!==qr)&&(s.blendEquation(s.FUNC_ADD),b=qr,z=qr),St)switch(I){case Vs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Go:s.blendFunc(s.ONE,s.ONE);break;case fp:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case hp:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case Vs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Go:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case fp:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case hp:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}D=null,V=null,F=null,ue=null,ve.set(0,0,0),T=0,N=I,P=St}return}$e=$e||Ee,yt=yt||we,At=At||He,(Ee!==b||$e!==z)&&(s.blendEquationSeparate(Ie[Ee],Ie[$e]),b=Ee,z=$e),(we!==D||He!==V||yt!==F||At!==ue)&&(s.blendFuncSeparate(je[we],je[He],je[yt],je[At]),D=we,V=He,F=yt,ue=At),(Bt.equals(ve)===!1||mn!==T)&&(s.blendColor(Bt.r,Bt.g,Bt.b,mn),ve.copy(Bt),T=mn),N=I,P=!1}function tt(I,Ee){I.side===Bi?be(s.CULL_FACE):ae(s.CULL_FACE);let we=I.side===Un;Ee&&(we=!we),Ye(we),I.blending===Vs&&I.transparent===!1?Ne(Sr):Ne(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),h.setFunc(I.depthFunc),h.setTest(I.depthTest),h.setMask(I.depthWrite),u.setMask(I.colorWrite);const He=I.stencilWrite;p.setTest(He),He&&(p.setMask(I.stencilWriteMask),p.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),p.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),te(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?ae(s.SAMPLE_ALPHA_TO_COVERAGE):be(s.SAMPLE_ALPHA_TO_COVERAGE)}function Ye(I){ee!==I&&(I?s.frontFace(s.CW):s.frontFace(s.CCW),ee=I)}function R(I){I!==k0?(ae(s.CULL_FACE),I!==fe&&(I===dp?s.cullFace(s.BACK):I===B0?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):be(s.CULL_FACE),fe=I}function A(I){I!==B&&(H&&s.lineWidth(I),B=I)}function te(I,Ee,we){I?(ae(s.POLYGON_OFFSET_FILL),(ne!==Ee||J!==we)&&(s.polygonOffset(Ee,we),ne=Ee,J=we)):be(s.POLYGON_OFFSET_FILL)}function Se(I){I?ae(s.SCISSOR_TEST):be(s.SCISSOR_TEST)}function _e(I){I===void 0&&(I=s.TEXTURE0+de-1),L!==I&&(s.activeTexture(I),L=I)}function Me(I,Ee,we){we===void 0&&(L===null?we=s.TEXTURE0+de-1:we=L);let He=W[we];He===void 0&&(He={type:void 0,texture:void 0},W[we]=He),(He.type!==I||He.texture!==Ee)&&(L!==we&&(s.activeTexture(we),L=we),s.bindTexture(I,Ee||ce[I]),He.type=I,He.texture=Ee)}function Ge(){const I=W[L];I!==void 0&&I.type!==void 0&&(s.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function Ce(){try{s.compressedTexImage2D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Fe(){try{s.compressedTexImage3D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ke(){try{s.texSubImage2D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function at(){try{s.texSubImage3D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ge(){try{s.compressedTexSubImage2D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function gt(){try{s.compressedTexSubImage3D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ft(){try{s.texStorage2D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function it(){try{s.texStorage3D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function qe(){try{s.texImage2D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function ke(){try{s.texImage3D.apply(s,arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function st(I){le.equals(I)===!1&&(s.scissor(I.x,I.y,I.z,I.w),le.copy(I))}function _t(I){he.equals(I)===!1&&(s.viewport(I.x,I.y,I.z,I.w),he.copy(I))}function wt(I,Ee){let we=_.get(Ee);we===void 0&&(we=new WeakMap,_.set(Ee,we));let He=we.get(I);He===void 0&&(He=s.getUniformBlockIndex(Ee,I.name),we.set(I,He))}function ct(I,Ee){const He=_.get(Ee).get(I);g.get(Ee)!==He&&(s.uniformBlockBinding(Ee,He,I.__bindingPointIndex),g.set(Ee,He))}function Et(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),r===!0&&(s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null)),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),y={},L=null,W={},S={},E=new WeakMap,w=[],v=null,x=!1,N=null,b=null,D=null,V=null,z=null,F=null,ue=null,ve=new We(0,0,0),T=0,P=!1,ee=null,fe=null,B=null,ne=null,J=null,le.set(0,0,s.canvas.width,s.canvas.height),he.set(0,0,s.canvas.width,s.canvas.height),u.reset(),h.reset(),p.reset()}return{buffers:{color:u,depth:h,stencil:p},enable:ae,disable:be,bindFramebuffer:ze,drawBuffers:q,useProgram:mt,setBlending:Ne,setMaterial:tt,setFlipSided:Ye,setCullFace:R,setLineWidth:A,setPolygonOffset:te,setScissorTest:Se,activeTexture:_e,bindTexture:Me,unbindTexture:Ge,compressedTexImage2D:Ce,compressedTexImage3D:Fe,texImage2D:qe,texImage3D:ke,updateUBOMapping:wt,uniformBlockBinding:ct,texStorage2D:ft,texStorage3D:it,texSubImage2D:Ke,texSubImage3D:at,compressedTexSubImage2D:ge,compressedTexSubImage3D:gt,scissor:st,viewport:_t,reset:Et}}function OE(s,e,n,r,a,l,d){const u=a.isWebGL2,h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let _;const y=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(R,A){return S?new OffscreenCanvas(R,A):Fl("canvas")}function w(R,A,te,Se){let _e=1;if((R.width>Se||R.height>Se)&&(_e=Se/Math.max(R.width,R.height)),_e<1||A===!0)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap){const Me=A?_d:Math.floor,Ge=Me(_e*R.width),Ce=Me(_e*R.height);_===void 0&&(_=E(Ge,Ce));const Fe=te?E(Ge,Ce):_;return Fe.width=Ge,Fe.height=Ce,Fe.getContext("2d").drawImage(R,0,0,Ge,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+R.width+"x"+R.height+") to ("+Ge+"x"+Ce+")."),Fe}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+R.width+"x"+R.height+")."),R;return R}function v(R){return Xp(R.width)&&Xp(R.height)}function x(R){return u?!1:R.wrapS!==li||R.wrapT!==li||R.minFilter!==Sn&&R.minFilter!==Dn}function N(R,A){return R.generateMipmaps&&A&&R.minFilter!==Sn&&R.minFilter!==Dn}function b(R){s.generateMipmap(R)}function D(R,A,te,Se,_e=!1){if(u===!1)return A;if(R!==null){if(s[R]!==void 0)return s[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let Me=A;if(A===s.RED&&(te===s.FLOAT&&(Me=s.R32F),te===s.HALF_FLOAT&&(Me=s.R16F),te===s.UNSIGNED_BYTE&&(Me=s.R8)),A===s.RED_INTEGER&&(te===s.UNSIGNED_BYTE&&(Me=s.R8UI),te===s.UNSIGNED_SHORT&&(Me=s.R16UI),te===s.UNSIGNED_INT&&(Me=s.R32UI),te===s.BYTE&&(Me=s.R8I),te===s.SHORT&&(Me=s.R16I),te===s.INT&&(Me=s.R32I)),A===s.RG&&(te===s.FLOAT&&(Me=s.RG32F),te===s.HALF_FLOAT&&(Me=s.RG16F),te===s.UNSIGNED_BYTE&&(Me=s.RG8)),A===s.RGBA){const Ge=_e?Dl:Ct.getTransfer(Se);te===s.FLOAT&&(Me=s.RGBA32F),te===s.HALF_FLOAT&&(Me=s.RGBA16F),te===s.UNSIGNED_BYTE&&(Me=Ge===Nt?s.SRGB8_ALPHA8:s.RGBA8),te===s.UNSIGNED_SHORT_4_4_4_4&&(Me=s.RGBA4),te===s.UNSIGNED_SHORT_5_5_5_1&&(Me=s.RGB5_A1)}return(Me===s.R16F||Me===s.R32F||Me===s.RG16F||Me===s.RG32F||Me===s.RGBA16F||Me===s.RGBA32F)&&e.get("EXT_color_buffer_float"),Me}function V(R,A,te){return N(R,te)===!0||R.isFramebufferTexture&&R.minFilter!==Sn&&R.minFilter!==Dn?Math.log2(Math.max(A.width,A.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?A.mipmaps.length:1}function z(R){return R===Sn||R===gp||R===Io?s.NEAREST:s.LINEAR}function F(R){const A=R.target;A.removeEventListener("dispose",F),ve(A),A.isVideoTexture&&g.delete(A)}function ue(R){const A=R.target;A.removeEventListener("dispose",ue),P(A)}function ve(R){const A=r.get(R);if(A.__webglInit===void 0)return;const te=R.source,Se=y.get(te);if(Se){const _e=Se[A.__cacheKey];_e.usedTimes--,_e.usedTimes===0&&T(R),Object.keys(Se).length===0&&y.delete(te)}r.remove(R)}function T(R){const A=r.get(R);s.deleteTexture(A.__webglTexture);const te=R.source,Se=y.get(te);delete Se[A.__cacheKey],d.memory.textures--}function P(R){const A=R.texture,te=r.get(R),Se=r.get(A);if(Se.__webglTexture!==void 0&&(s.deleteTexture(Se.__webglTexture),d.memory.textures--),R.depthTexture&&R.depthTexture.dispose(),R.isWebGLCubeRenderTarget)for(let _e=0;_e<6;_e++){if(Array.isArray(te.__webglFramebuffer[_e]))for(let Me=0;Me<te.__webglFramebuffer[_e].length;Me++)s.deleteFramebuffer(te.__webglFramebuffer[_e][Me]);else s.deleteFramebuffer(te.__webglFramebuffer[_e]);te.__webglDepthbuffer&&s.deleteRenderbuffer(te.__webglDepthbuffer[_e])}else{if(Array.isArray(te.__webglFramebuffer))for(let _e=0;_e<te.__webglFramebuffer.length;_e++)s.deleteFramebuffer(te.__webglFramebuffer[_e]);else s.deleteFramebuffer(te.__webglFramebuffer);if(te.__webglDepthbuffer&&s.deleteRenderbuffer(te.__webglDepthbuffer),te.__webglMultisampledFramebuffer&&s.deleteFramebuffer(te.__webglMultisampledFramebuffer),te.__webglColorRenderbuffer)for(let _e=0;_e<te.__webglColorRenderbuffer.length;_e++)te.__webglColorRenderbuffer[_e]&&s.deleteRenderbuffer(te.__webglColorRenderbuffer[_e]);te.__webglDepthRenderbuffer&&s.deleteRenderbuffer(te.__webglDepthRenderbuffer)}if(R.isWebGLMultipleRenderTargets)for(let _e=0,Me=A.length;_e<Me;_e++){const Ge=r.get(A[_e]);Ge.__webglTexture&&(s.deleteTexture(Ge.__webglTexture),d.memory.textures--),r.remove(A[_e])}r.remove(A),r.remove(R)}let ee=0;function fe(){ee=0}function B(){const R=ee;return R>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+a.maxTextures),ee+=1,R}function ne(R){const A=[];return A.push(R.wrapS),A.push(R.wrapT),A.push(R.wrapR||0),A.push(R.magFilter),A.push(R.minFilter),A.push(R.anisotropy),A.push(R.internalFormat),A.push(R.format),A.push(R.type),A.push(R.generateMipmaps),A.push(R.premultiplyAlpha),A.push(R.flipY),A.push(R.unpackAlignment),A.push(R.colorSpace),A.join()}function J(R,A){const te=r.get(R);if(R.isVideoTexture&&tt(R),R.isRenderTargetTexture===!1&&R.version>0&&te.__version!==R.version){const Se=R.image;if(Se===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Se.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{le(te,R,A);return}}n.bindTexture(s.TEXTURE_2D,te.__webglTexture,s.TEXTURE0+A)}function de(R,A){const te=r.get(R);if(R.version>0&&te.__version!==R.version){le(te,R,A);return}n.bindTexture(s.TEXTURE_2D_ARRAY,te.__webglTexture,s.TEXTURE0+A)}function H(R,A){const te=r.get(R);if(R.version>0&&te.__version!==R.version){le(te,R,A);return}n.bindTexture(s.TEXTURE_3D,te.__webglTexture,s.TEXTURE0+A)}function $(R,A){const te=r.get(R);if(R.version>0&&te.__version!==R.version){he(te,R,A);return}n.bindTexture(s.TEXTURE_CUBE_MAP,te.__webglTexture,s.TEXTURE0+A)}const X={[pd]:s.REPEAT,[li]:s.CLAMP_TO_EDGE,[md]:s.MIRRORED_REPEAT},L={[Sn]:s.NEAREST,[gp]:s.NEAREST_MIPMAP_NEAREST,[Io]:s.NEAREST_MIPMAP_LINEAR,[Dn]:s.LINEAR,[Ru]:s.LINEAR_MIPMAP_NEAREST,[$r]:s.LINEAR_MIPMAP_LINEAR},W={[P_]:s.NEVER,[F_]:s.ALWAYS,[L_]:s.LESS,[rg]:s.LEQUAL,[D_]:s.EQUAL,[I_]:s.GEQUAL,[N_]:s.GREATER,[U_]:s.NOTEQUAL};function ye(R,A,te){if(A.type===Hi&&e.has("OES_texture_float_linear")===!1&&(A.magFilter===Dn||A.magFilter===Ru||A.magFilter===Io||A.magFilter===$r||A.minFilter===Dn||A.minFilter===Ru||A.minFilter===Io||A.minFilter===$r)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),te?(s.texParameteri(R,s.TEXTURE_WRAP_S,X[A.wrapS]),s.texParameteri(R,s.TEXTURE_WRAP_T,X[A.wrapT]),(R===s.TEXTURE_3D||R===s.TEXTURE_2D_ARRAY)&&s.texParameteri(R,s.TEXTURE_WRAP_R,X[A.wrapR]),s.texParameteri(R,s.TEXTURE_MAG_FILTER,L[A.magFilter]),s.texParameteri(R,s.TEXTURE_MIN_FILTER,L[A.minFilter])):(s.texParameteri(R,s.TEXTURE_WRAP_S,s.CLAMP_TO_EDGE),s.texParameteri(R,s.TEXTURE_WRAP_T,s.CLAMP_TO_EDGE),(R===s.TEXTURE_3D||R===s.TEXTURE_2D_ARRAY)&&s.texParameteri(R,s.TEXTURE_WRAP_R,s.CLAMP_TO_EDGE),(A.wrapS!==li||A.wrapT!==li)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),s.texParameteri(R,s.TEXTURE_MAG_FILTER,z(A.magFilter)),s.texParameteri(R,s.TEXTURE_MIN_FILTER,z(A.minFilter)),A.minFilter!==Sn&&A.minFilter!==Dn&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),A.compareFunction&&(s.texParameteri(R,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(R,s.TEXTURE_COMPARE_FUNC,W[A.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){const Se=e.get("EXT_texture_filter_anisotropic");if(A.magFilter===Sn||A.minFilter!==Io&&A.minFilter!==$r||A.type===Hi&&e.has("OES_texture_float_linear")===!1||u===!1&&A.type===Vo&&e.has("OES_texture_half_float_linear")===!1)return;(A.anisotropy>1||r.get(A).__currentAnisotropy)&&(s.texParameterf(R,Se.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(A.anisotropy,a.getMaxAnisotropy())),r.get(A).__currentAnisotropy=A.anisotropy)}}function j(R,A){let te=!1;R.__webglInit===void 0&&(R.__webglInit=!0,A.addEventListener("dispose",F));const Se=A.source;let _e=y.get(Se);_e===void 0&&(_e={},y.set(Se,_e));const Me=ne(A);if(Me!==R.__cacheKey){_e[Me]===void 0&&(_e[Me]={texture:s.createTexture(),usedTimes:0},d.memory.textures++,te=!0),_e[Me].usedTimes++;const Ge=_e[R.__cacheKey];Ge!==void 0&&(_e[R.__cacheKey].usedTimes--,Ge.usedTimes===0&&T(A)),R.__cacheKey=Me,R.__webglTexture=_e[Me].texture}return te}function le(R,A,te){let Se=s.TEXTURE_2D;(A.isDataArrayTexture||A.isCompressedArrayTexture)&&(Se=s.TEXTURE_2D_ARRAY),A.isData3DTexture&&(Se=s.TEXTURE_3D);const _e=j(R,A),Me=A.source;n.bindTexture(Se,R.__webglTexture,s.TEXTURE0+te);const Ge=r.get(Me);if(Me.version!==Ge.__version||_e===!0){n.activeTexture(s.TEXTURE0+te);const Ce=Ct.getPrimaries(Ct.workingColorSpace),Fe=A.colorSpace===Qn?null:Ct.getPrimaries(A.colorSpace),Ke=A.colorSpace===Qn||Ce===Fe?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);const at=x(A)&&v(A.image)===!1;let ge=w(A.image,at,!1,a.maxTextureSize);ge=Ye(A,ge);const gt=v(ge)||u,ft=l.convert(A.format,A.colorSpace);let it=l.convert(A.type),qe=D(A.internalFormat,ft,it,A.colorSpace,A.isVideoTexture);ye(Se,A,gt);let ke;const st=A.mipmaps,_t=u&&A.isVideoTexture!==!0&&qe!==ng,wt=Ge.__version===void 0||_e===!0,ct=Me.dataReady,Et=V(A,ge,gt);if(A.isDepthTexture)qe=s.DEPTH_COMPONENT,u?A.type===Hi?qe=s.DEPTH_COMPONENT32F:A.type===yr?qe=s.DEPTH_COMPONENT24:A.type===Kr?qe=s.DEPTH24_STENCIL8:qe=s.DEPTH_COMPONENT16:A.type===Hi&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),A.format===Zr&&qe===s.DEPTH_COMPONENT&&A.type!==wd&&A.type!==yr&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),A.type=yr,it=l.convert(A.type)),A.format===$s&&qe===s.DEPTH_COMPONENT&&(qe=s.DEPTH_STENCIL,A.type!==Kr&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),A.type=Kr,it=l.convert(A.type))),wt&&(_t?n.texStorage2D(s.TEXTURE_2D,1,qe,ge.width,ge.height):n.texImage2D(s.TEXTURE_2D,0,qe,ge.width,ge.height,0,ft,it,null));else if(A.isDataTexture)if(st.length>0&&gt){_t&&wt&&n.texStorage2D(s.TEXTURE_2D,Et,qe,st[0].width,st[0].height);for(let I=0,Ee=st.length;I<Ee;I++)ke=st[I],_t?ct&&n.texSubImage2D(s.TEXTURE_2D,I,0,0,ke.width,ke.height,ft,it,ke.data):n.texImage2D(s.TEXTURE_2D,I,qe,ke.width,ke.height,0,ft,it,ke.data);A.generateMipmaps=!1}else _t?(wt&&n.texStorage2D(s.TEXTURE_2D,Et,qe,ge.width,ge.height),ct&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,ge.width,ge.height,ft,it,ge.data)):n.texImage2D(s.TEXTURE_2D,0,qe,ge.width,ge.height,0,ft,it,ge.data);else if(A.isCompressedTexture)if(A.isCompressedArrayTexture){_t&&wt&&n.texStorage3D(s.TEXTURE_2D_ARRAY,Et,qe,st[0].width,st[0].height,ge.depth);for(let I=0,Ee=st.length;I<Ee;I++)ke=st[I],A.format!==ci?ft!==null?_t?ct&&n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,I,0,0,0,ke.width,ke.height,ge.depth,ft,ke.data,0,0):n.compressedTexImage3D(s.TEXTURE_2D_ARRAY,I,qe,ke.width,ke.height,ge.depth,0,ke.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):_t?ct&&n.texSubImage3D(s.TEXTURE_2D_ARRAY,I,0,0,0,ke.width,ke.height,ge.depth,ft,it,ke.data):n.texImage3D(s.TEXTURE_2D_ARRAY,I,qe,ke.width,ke.height,ge.depth,0,ft,it,ke.data)}else{_t&&wt&&n.texStorage2D(s.TEXTURE_2D,Et,qe,st[0].width,st[0].height);for(let I=0,Ee=st.length;I<Ee;I++)ke=st[I],A.format!==ci?ft!==null?_t?ct&&n.compressedTexSubImage2D(s.TEXTURE_2D,I,0,0,ke.width,ke.height,ft,ke.data):n.compressedTexImage2D(s.TEXTURE_2D,I,qe,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):_t?ct&&n.texSubImage2D(s.TEXTURE_2D,I,0,0,ke.width,ke.height,ft,it,ke.data):n.texImage2D(s.TEXTURE_2D,I,qe,ke.width,ke.height,0,ft,it,ke.data)}else if(A.isDataArrayTexture)_t?(wt&&n.texStorage3D(s.TEXTURE_2D_ARRAY,Et,qe,ge.width,ge.height,ge.depth),ct&&n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,ge.width,ge.height,ge.depth,ft,it,ge.data)):n.texImage3D(s.TEXTURE_2D_ARRAY,0,qe,ge.width,ge.height,ge.depth,0,ft,it,ge.data);else if(A.isData3DTexture)_t?(wt&&n.texStorage3D(s.TEXTURE_3D,Et,qe,ge.width,ge.height,ge.depth),ct&&n.texSubImage3D(s.TEXTURE_3D,0,0,0,0,ge.width,ge.height,ge.depth,ft,it,ge.data)):n.texImage3D(s.TEXTURE_3D,0,qe,ge.width,ge.height,ge.depth,0,ft,it,ge.data);else if(A.isFramebufferTexture){if(wt)if(_t)n.texStorage2D(s.TEXTURE_2D,Et,qe,ge.width,ge.height);else{let I=ge.width,Ee=ge.height;for(let we=0;we<Et;we++)n.texImage2D(s.TEXTURE_2D,we,qe,I,Ee,0,ft,it,null),I>>=1,Ee>>=1}}else if(st.length>0&&gt){_t&&wt&&n.texStorage2D(s.TEXTURE_2D,Et,qe,st[0].width,st[0].height);for(let I=0,Ee=st.length;I<Ee;I++)ke=st[I],_t?ct&&n.texSubImage2D(s.TEXTURE_2D,I,0,0,ft,it,ke):n.texImage2D(s.TEXTURE_2D,I,qe,ft,it,ke);A.generateMipmaps=!1}else _t?(wt&&n.texStorage2D(s.TEXTURE_2D,Et,qe,ge.width,ge.height),ct&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,ft,it,ge)):n.texImage2D(s.TEXTURE_2D,0,qe,ft,it,ge);N(A,gt)&&b(Se),Ge.__version=Me.version,A.onUpdate&&A.onUpdate(A)}R.__version=A.version}function he(R,A,te){if(A.image.length!==6)return;const Se=j(R,A),_e=A.source;n.bindTexture(s.TEXTURE_CUBE_MAP,R.__webglTexture,s.TEXTURE0+te);const Me=r.get(_e);if(_e.version!==Me.__version||Se===!0){n.activeTexture(s.TEXTURE0+te);const Ge=Ct.getPrimaries(Ct.workingColorSpace),Ce=A.colorSpace===Qn?null:Ct.getPrimaries(A.colorSpace),Fe=A.colorSpace===Qn||Ge===Ce?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,A.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,A.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,A.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Fe);const Ke=A.isCompressedTexture||A.image[0].isCompressedTexture,at=A.image[0]&&A.image[0].isDataTexture,ge=[];for(let I=0;I<6;I++)!Ke&&!at?ge[I]=w(A.image[I],!1,!0,a.maxCubemapSize):ge[I]=at?A.image[I].image:A.image[I],ge[I]=Ye(A,ge[I]);const gt=ge[0],ft=v(gt)||u,it=l.convert(A.format,A.colorSpace),qe=l.convert(A.type),ke=D(A.internalFormat,it,qe,A.colorSpace),st=u&&A.isVideoTexture!==!0,_t=Me.__version===void 0||Se===!0,wt=_e.dataReady;let ct=V(A,gt,ft);ye(s.TEXTURE_CUBE_MAP,A,ft);let Et;if(Ke){st&&_t&&n.texStorage2D(s.TEXTURE_CUBE_MAP,ct,ke,gt.width,gt.height);for(let I=0;I<6;I++){Et=ge[I].mipmaps;for(let Ee=0;Ee<Et.length;Ee++){const we=Et[Ee];A.format!==ci?it!==null?st?wt&&n.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee,0,0,we.width,we.height,it,we.data):n.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee,ke,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):st?wt&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee,0,0,we.width,we.height,it,qe,we.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee,ke,we.width,we.height,0,it,qe,we.data)}}}else{Et=A.mipmaps,st&&_t&&(Et.length>0&&ct++,n.texStorage2D(s.TEXTURE_CUBE_MAP,ct,ke,ge[0].width,ge[0].height));for(let I=0;I<6;I++)if(at){st?wt&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,0,0,0,ge[I].width,ge[I].height,it,qe,ge[I].data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,0,ke,ge[I].width,ge[I].height,0,it,qe,ge[I].data);for(let Ee=0;Ee<Et.length;Ee++){const He=Et[Ee].image[I].image;st?wt&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee+1,0,0,He.width,He.height,it,qe,He.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee+1,ke,He.width,He.height,0,it,qe,He.data)}}else{st?wt&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,0,0,0,it,qe,ge[I]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,0,ke,it,qe,ge[I]);for(let Ee=0;Ee<Et.length;Ee++){const we=Et[Ee];st?wt&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee+1,0,0,it,qe,we.image[I]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+I,Ee+1,ke,it,qe,we.image[I])}}}N(A,ft)&&b(s.TEXTURE_CUBE_MAP),Me.__version=_e.version,A.onUpdate&&A.onUpdate(A)}R.__version=A.version}function Ae(R,A,te,Se,_e,Me){const Ge=l.convert(te.format,te.colorSpace),Ce=l.convert(te.type),Fe=D(te.internalFormat,Ge,Ce,te.colorSpace);if(!r.get(A).__hasExternalTextures){const at=Math.max(1,A.width>>Me),ge=Math.max(1,A.height>>Me);_e===s.TEXTURE_3D||_e===s.TEXTURE_2D_ARRAY?n.texImage3D(_e,Me,Fe,at,ge,A.depth,0,Ge,Ce,null):n.texImage2D(_e,Me,Fe,at,ge,0,Ge,Ce,null)}n.bindFramebuffer(s.FRAMEBUFFER,R),Ne(A)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,Se,_e,r.get(te).__webglTexture,0,je(A)):(_e===s.TEXTURE_2D||_e>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&_e<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,Se,_e,r.get(te).__webglTexture,Me),n.bindFramebuffer(s.FRAMEBUFFER,null)}function ce(R,A,te){if(s.bindRenderbuffer(s.RENDERBUFFER,R),A.depthBuffer&&!A.stencilBuffer){let Se=u===!0?s.DEPTH_COMPONENT24:s.DEPTH_COMPONENT16;if(te||Ne(A)){const _e=A.depthTexture;_e&&_e.isDepthTexture&&(_e.type===Hi?Se=s.DEPTH_COMPONENT32F:_e.type===yr&&(Se=s.DEPTH_COMPONENT24));const Me=je(A);Ne(A)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Me,Se,A.width,A.height):s.renderbufferStorageMultisample(s.RENDERBUFFER,Me,Se,A.width,A.height)}else s.renderbufferStorage(s.RENDERBUFFER,Se,A.width,A.height);s.framebufferRenderbuffer(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.RENDERBUFFER,R)}else if(A.depthBuffer&&A.stencilBuffer){const Se=je(A);te&&Ne(A)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Se,s.DEPTH24_STENCIL8,A.width,A.height):Ne(A)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Se,s.DEPTH24_STENCIL8,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,s.DEPTH_STENCIL,A.width,A.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.RENDERBUFFER,R)}else{const Se=A.isWebGLMultipleRenderTargets===!0?A.texture:[A.texture];for(let _e=0;_e<Se.length;_e++){const Me=Se[_e],Ge=l.convert(Me.format,Me.colorSpace),Ce=l.convert(Me.type),Fe=D(Me.internalFormat,Ge,Ce,Me.colorSpace),Ke=je(A);te&&Ne(A)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ke,Fe,A.width,A.height):Ne(A)?h.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ke,Fe,A.width,A.height):s.renderbufferStorage(s.RENDERBUFFER,Fe,A.width,A.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function ae(R,A){if(A&&A.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(s.FRAMEBUFFER,R),!(A.depthTexture&&A.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!r.get(A.depthTexture).__webglTexture||A.depthTexture.image.width!==A.width||A.depthTexture.image.height!==A.height)&&(A.depthTexture.image.width=A.width,A.depthTexture.image.height=A.height,A.depthTexture.needsUpdate=!0),J(A.depthTexture,0);const Se=r.get(A.depthTexture).__webglTexture,_e=je(A);if(A.depthTexture.format===Zr)Ne(A)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Se,0,_e):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,Se,0);else if(A.depthTexture.format===$s)Ne(A)?h.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Se,0,_e):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,Se,0);else throw new Error("Unknown depthTexture format")}function be(R){const A=r.get(R),te=R.isWebGLCubeRenderTarget===!0;if(R.depthTexture&&!A.__autoAllocateDepthBuffer){if(te)throw new Error("target.depthTexture not supported in Cube render targets");ae(A.__webglFramebuffer,R)}else if(te){A.__webglDepthbuffer=[];for(let Se=0;Se<6;Se++)n.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer[Se]),A.__webglDepthbuffer[Se]=s.createRenderbuffer(),ce(A.__webglDepthbuffer[Se],R,!1)}else n.bindFramebuffer(s.FRAMEBUFFER,A.__webglFramebuffer),A.__webglDepthbuffer=s.createRenderbuffer(),ce(A.__webglDepthbuffer,R,!1);n.bindFramebuffer(s.FRAMEBUFFER,null)}function ze(R,A,te){const Se=r.get(R);A!==void 0&&Ae(Se.__webglFramebuffer,R,R.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),te!==void 0&&be(R)}function q(R){const A=R.texture,te=r.get(R),Se=r.get(A);R.addEventListener("dispose",ue),R.isWebGLMultipleRenderTargets!==!0&&(Se.__webglTexture===void 0&&(Se.__webglTexture=s.createTexture()),Se.__version=A.version,d.memory.textures++);const _e=R.isWebGLCubeRenderTarget===!0,Me=R.isWebGLMultipleRenderTargets===!0,Ge=v(R)||u;if(_e){te.__webglFramebuffer=[];for(let Ce=0;Ce<6;Ce++)if(u&&A.mipmaps&&A.mipmaps.length>0){te.__webglFramebuffer[Ce]=[];for(let Fe=0;Fe<A.mipmaps.length;Fe++)te.__webglFramebuffer[Ce][Fe]=s.createFramebuffer()}else te.__webglFramebuffer[Ce]=s.createFramebuffer()}else{if(u&&A.mipmaps&&A.mipmaps.length>0){te.__webglFramebuffer=[];for(let Ce=0;Ce<A.mipmaps.length;Ce++)te.__webglFramebuffer[Ce]=s.createFramebuffer()}else te.__webglFramebuffer=s.createFramebuffer();if(Me)if(a.drawBuffers){const Ce=R.texture;for(let Fe=0,Ke=Ce.length;Fe<Ke;Fe++){const at=r.get(Ce[Fe]);at.__webglTexture===void 0&&(at.__webglTexture=s.createTexture(),d.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(u&&R.samples>0&&Ne(R)===!1){const Ce=Me?A:[A];te.__webglMultisampledFramebuffer=s.createFramebuffer(),te.__webglColorRenderbuffer=[],n.bindFramebuffer(s.FRAMEBUFFER,te.__webglMultisampledFramebuffer);for(let Fe=0;Fe<Ce.length;Fe++){const Ke=Ce[Fe];te.__webglColorRenderbuffer[Fe]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,te.__webglColorRenderbuffer[Fe]);const at=l.convert(Ke.format,Ke.colorSpace),ge=l.convert(Ke.type),gt=D(Ke.internalFormat,at,ge,Ke.colorSpace,R.isXRRenderTarget===!0),ft=je(R);s.renderbufferStorageMultisample(s.RENDERBUFFER,ft,gt,R.width,R.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Fe,s.RENDERBUFFER,te.__webglColorRenderbuffer[Fe])}s.bindRenderbuffer(s.RENDERBUFFER,null),R.depthBuffer&&(te.__webglDepthRenderbuffer=s.createRenderbuffer(),ce(te.__webglDepthRenderbuffer,R,!0)),n.bindFramebuffer(s.FRAMEBUFFER,null)}}if(_e){n.bindTexture(s.TEXTURE_CUBE_MAP,Se.__webglTexture),ye(s.TEXTURE_CUBE_MAP,A,Ge);for(let Ce=0;Ce<6;Ce++)if(u&&A.mipmaps&&A.mipmaps.length>0)for(let Fe=0;Fe<A.mipmaps.length;Fe++)Ae(te.__webglFramebuffer[Ce][Fe],R,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,Fe);else Ae(te.__webglFramebuffer[Ce],R,A,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0);N(A,Ge)&&b(s.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Me){const Ce=R.texture;for(let Fe=0,Ke=Ce.length;Fe<Ke;Fe++){const at=Ce[Fe],ge=r.get(at);n.bindTexture(s.TEXTURE_2D,ge.__webglTexture),ye(s.TEXTURE_2D,at,Ge),Ae(te.__webglFramebuffer,R,at,s.COLOR_ATTACHMENT0+Fe,s.TEXTURE_2D,0),N(at,Ge)&&b(s.TEXTURE_2D)}n.unbindTexture()}else{let Ce=s.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(u?Ce=R.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),n.bindTexture(Ce,Se.__webglTexture),ye(Ce,A,Ge),u&&A.mipmaps&&A.mipmaps.length>0)for(let Fe=0;Fe<A.mipmaps.length;Fe++)Ae(te.__webglFramebuffer[Fe],R,A,s.COLOR_ATTACHMENT0,Ce,Fe);else Ae(te.__webglFramebuffer,R,A,s.COLOR_ATTACHMENT0,Ce,0);N(A,Ge)&&b(Ce),n.unbindTexture()}R.depthBuffer&&be(R)}function mt(R){const A=v(R)||u,te=R.isWebGLMultipleRenderTargets===!0?R.texture:[R.texture];for(let Se=0,_e=te.length;Se<_e;Se++){const Me=te[Se];if(N(Me,A)){const Ge=R.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:s.TEXTURE_2D,Ce=r.get(Me).__webglTexture;n.bindTexture(Ge,Ce),b(Ge),n.unbindTexture()}}}function Ie(R){if(u&&R.samples>0&&Ne(R)===!1){const A=R.isWebGLMultipleRenderTargets?R.texture:[R.texture],te=R.width,Se=R.height;let _e=s.COLOR_BUFFER_BIT;const Me=[],Ge=R.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ce=r.get(R),Fe=R.isWebGLMultipleRenderTargets===!0;if(Fe)for(let Ke=0;Ke<A.length;Ke++)n.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ke,s.RENDERBUFFER,null),n.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ke,s.TEXTURE_2D,null,0);n.bindFramebuffer(s.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),n.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Ke=0;Ke<A.length;Ke++){Me.push(s.COLOR_ATTACHMENT0+Ke),R.depthBuffer&&Me.push(Ge);const at=Ce.__ignoreDepthValues!==void 0?Ce.__ignoreDepthValues:!1;if(at===!1&&(R.depthBuffer&&(_e|=s.DEPTH_BUFFER_BIT),R.stencilBuffer&&(_e|=s.STENCIL_BUFFER_BIT)),Fe&&s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ke]),at===!0&&(s.invalidateFramebuffer(s.READ_FRAMEBUFFER,[Ge]),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[Ge])),Fe){const ge=r.get(A[Ke]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,ge,0)}s.blitFramebuffer(0,0,te,Se,0,0,te,Se,_e,s.NEAREST),p&&s.invalidateFramebuffer(s.READ_FRAMEBUFFER,Me)}if(n.bindFramebuffer(s.READ_FRAMEBUFFER,null),n.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Fe)for(let Ke=0;Ke<A.length;Ke++){n.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ke,s.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ke]);const at=r.get(A[Ke]).__webglTexture;n.bindFramebuffer(s.FRAMEBUFFER,Ce.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ke,s.TEXTURE_2D,at,0)}n.bindFramebuffer(s.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}}function je(R){return Math.min(a.maxSamples,R.samples)}function Ne(R){const A=r.get(R);return u&&R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&A.__useRenderToTexture!==!1}function tt(R){const A=d.render.frame;g.get(R)!==A&&(g.set(R,A),R.update())}function Ye(R,A){const te=R.colorSpace,Se=R.format,_e=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||R.format===gd||te!==Xi&&te!==Qn&&(Ct.getTransfer(te)===Nt?u===!1?e.has("EXT_sRGB")===!0&&Se===ci?(R.format=gd,R.minFilter=Dn,R.generateMipmaps=!1):A=og.sRGBToLinear(A):(Se!==ci||_e!==Er)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",te)),A}this.allocateTextureUnit=B,this.resetTextureUnits=fe,this.setTexture2D=J,this.setTexture2DArray=de,this.setTexture3D=H,this.setTextureCube=$,this.rebindTextures=ze,this.setupRenderTarget=q,this.updateRenderTargetMipmap=mt,this.updateMultisampleRenderTarget=Ie,this.setupDepthRenderbuffer=be,this.setupFrameBufferTexture=Ae,this.useMultisampledRTT=Ne}function zE(s,e,n){const r=n.isWebGL2;function a(l,d=Qn){let u;const h=Ct.getTransfer(d);if(l===Er)return s.UNSIGNED_BYTE;if(l===Zm)return s.UNSIGNED_SHORT_4_4_4_4;if(l===Qm)return s.UNSIGNED_SHORT_5_5_5_1;if(l===__)return s.BYTE;if(l===x_)return s.SHORT;if(l===wd)return s.UNSIGNED_SHORT;if(l===Km)return s.INT;if(l===yr)return s.UNSIGNED_INT;if(l===Hi)return s.FLOAT;if(l===Vo)return r?s.HALF_FLOAT:(u=e.get("OES_texture_half_float"),u!==null?u.HALF_FLOAT_OES:null);if(l===y_)return s.ALPHA;if(l===ci)return s.RGBA;if(l===S_)return s.LUMINANCE;if(l===M_)return s.LUMINANCE_ALPHA;if(l===Zr)return s.DEPTH_COMPONENT;if(l===$s)return s.DEPTH_STENCIL;if(l===gd)return u=e.get("EXT_sRGB"),u!==null?u.SRGB_ALPHA_EXT:null;if(l===E_)return s.RED;if(l===Jm)return s.RED_INTEGER;if(l===T_)return s.RG;if(l===eg)return s.RG_INTEGER;if(l===tg)return s.RGBA_INTEGER;if(l===Cu||l===bu||l===Pu||l===Lu)if(h===Nt)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(l===Cu)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(l===bu)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(l===Pu)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(l===Lu)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(l===Cu)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(l===bu)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(l===Pu)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(l===Lu)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(l===vp||l===_p||l===xp||l===yp)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(l===vp)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(l===_p)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(l===xp)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(l===yp)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(l===ng)return u=e.get("WEBGL_compressed_texture_etc1"),u!==null?u.COMPRESSED_RGB_ETC1_WEBGL:null;if(l===Sp||l===Mp)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(l===Sp)return h===Nt?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(l===Mp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(l===Ep||l===Tp||l===wp||l===Ap||l===Rp||l===Cp||l===bp||l===Pp||l===Lp||l===Dp||l===Np||l===Up||l===Ip||l===Fp)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(l===Ep)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(l===Tp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(l===wp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(l===Ap)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(l===Rp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(l===Cp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(l===bp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(l===Pp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(l===Lp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(l===Dp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(l===Np)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(l===Up)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(l===Ip)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(l===Fp)return h===Nt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(l===Du||l===Op||l===zp)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(l===Du)return h===Nt?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(l===Op)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(l===zp)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(l===w_||l===kp||l===Bp||l===Hp)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(l===Du)return u.COMPRESSED_RED_RGTC1_EXT;if(l===kp)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(l===Bp)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(l===Hp)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return l===Kr?r?s.UNSIGNED_INT_24_8:(u=e.get("WEBGL_depth_texture"),u!==null?u.UNSIGNED_INT_24_8_WEBGL:null):s[l]!==void 0?s[l]:null}return{convert:a}}class kE extends Zn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Ho extends Fn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const BE={type:"move"};class id{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Ho,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Ho,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new Y,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new Y),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Ho,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new Y,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new Y),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const n=this._hand;if(n)for(const r of e.hand.values())this._getHandJoint(n,r)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,n,r){let a=null,l=null,d=null;const u=this._targetRay,h=this._grip,p=this._hand;if(e&&n.session.visibilityState!=="visible-blurred"){if(p&&e.hand){d=!0;for(const w of e.hand.values()){const v=n.getJointPose(w,r),x=this._getHandJoint(p,w);v!==null&&(x.matrix.fromArray(v.transform.matrix),x.matrix.decompose(x.position,x.rotation,x.scale),x.matrixWorldNeedsUpdate=!0,x.jointRadius=v.radius),x.visible=v!==null}const g=p.joints["index-finger-tip"],_=p.joints["thumb-tip"],y=g.position.distanceTo(_.position),S=.02,E=.005;p.inputState.pinching&&y>S+E?(p.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!p.inputState.pinching&&y<=S-E&&(p.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else h!==null&&e.gripSpace&&(l=n.getPose(e.gripSpace,r),l!==null&&(h.matrix.fromArray(l.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,l.linearVelocity?(h.hasLinearVelocity=!0,h.linearVelocity.copy(l.linearVelocity)):h.hasLinearVelocity=!1,l.angularVelocity?(h.hasAngularVelocity=!0,h.angularVelocity.copy(l.angularVelocity)):h.hasAngularVelocity=!1));u!==null&&(a=n.getPose(e.targetRaySpace,r),a===null&&l!==null&&(a=l),a!==null&&(u.matrix.fromArray(a.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,a.linearVelocity?(u.hasLinearVelocity=!0,u.linearVelocity.copy(a.linearVelocity)):u.hasLinearVelocity=!1,a.angularVelocity?(u.hasAngularVelocity=!0,u.angularVelocity.copy(a.angularVelocity)):u.hasAngularVelocity=!1,this.dispatchEvent(BE)))}return u!==null&&(u.visible=a!==null),h!==null&&(h.visible=l!==null),p!==null&&(p.visible=d!==null),this}_getHandJoint(e,n){if(e.joints[n.jointName]===void 0){const r=new Ho;r.matrixAutoUpdate=!1,r.visible=!1,e.joints[n.jointName]=r,e.add(r)}return e.joints[n.jointName]}}const HE=`
void main() {
...
}`;class VE{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n,r){if(this.texture===null){const a=new In,l=e.properties.get(a);l.__webglTexture=n.texture,(n.depthNear!=r.depthNear||n.depthFar!=r.depthFar)&&(this.depthNear=n.depthNear,this.depthFar=n.depthFar),this.texture=a}}render(e,n){if(this.texture!==null){if(this.mesh===null){const r=n.cameras[0].viewport,a=new Mi({extensions:{fragDepth:!0},vertexShader:HE,fragmentShader:GE,uniforms:{depthColor:{value:this.texture},depthWidth:{value:r.z},depthHeight:{value:r.w}}});this.mesh=new Wi(new Hl(20,20),a)}e.render(this.mesh,n)}}reset(){this.texture=null,this.mesh=null}}class WE extends Zs{constructor(e,n){super();const r=this;let a=null,l=1,d=null,u="local-floor",h=1,p=null,g=null,_=null,y=null,S=null,E=null;const w=new VE,v=n.getContextAttributes();let x=null,N=null;const b=[],D=[],V=new Tt;let z=null;const F=new Zn;F.layers.enable(1),F.viewport=new sn;const ue=new Zn;ue.layers.enable(2),ue.viewport=new sn;const ve=[F,ue],T=new kE;T.layers.enable(1),T.layers.enable(2);let P=null,ee=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let le=b[j];return le===void 0&&(le=new id,b[j]=le),le.getTargetRaySpace()},this.getControllerGrip=function(j){let le=b[j];return le===void 0&&(le=new id,b[j]=le),le.getGripSpace()},this.getHand=function(j){let le=b[j];return le===void 0&&(le=new id,b[j]=le),le.getHandSpace()};function fe(j){const le=D.indexOf(j.inputSource);if(le===-1)return;const he=b[le];he!==void 0&&(he.update(j.inputSource,j.frame,p||d),he.dispatchEvent({type:j.type,data:j.inputSource}))}function B(){a.removeEventListener("select",fe),a.removeEventListener("selectstart",fe),a.removeEventListener("selectend",fe),a.removeEventListener("squeeze",fe),a.removeEventListener("squeezestart",fe),a.removeEventListener("squeezeend",fe),a.removeEventListener("end",B),a.removeEventListener("inputsourceschange",ne);for(let j=0;j<b.length;j++){const le=D[j];le!==null&&(D[j]=null,b[j].disconnect(le))}P=null,ee=null,w.reset(),e.setRenderTarget(x),S=null,y=null,_=null,a=null,N=null,ye.stop(),r.isPresenting=!1,e.setPixelRatio(z),e.setSize(V.width,V.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){l=j,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){u=j,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(j){p=j},this.getBaseLayer=function(){return y!==null?y:S},this.getBinding=function(){return _},this.getFrame=function(){return E},this.getSession=function(){return a},this.setSession=async function(j){if(a=j,a!==null){if(x=e.getRenderTarget(),a.addEventListener("select",fe),a.addEventListener("selectstart",fe),a.addEventListener("selectend",fe),a.addEventListener("squeeze",fe),a.addEventListener("squeezestart",fe),a.addEventListener("squeezeend",fe),a.addEventListener("end",B),a.addEventListener("inputsourceschange",ne),v.xrCompatible!==!0&&await n.makeXRCompatible(),z=e.getPixelRatio(),e.getSize(V),a.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const le={antialias:a.renderState.layers===void 0?v.antialias:!0,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:l};S=new XRWebGLLayer(a,n,le),a.updateRenderState({baseLayer:S}),e.setPixelRatio(1),e.setSize(S.framebufferWidth,S.framebufferHeight,!1),N=new Jr(S.framebufferWidth,S.framebufferHeight,{format:ci,type:Er,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil})}else{let le=null,he=null,Ae=null;v.depth&&(Ae=v.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,le=v.stencil?$s:Zr,he=v.stencil?Kr:yr);const ce={colorFormat:n.RGBA8,depthFormat:Ae,scaleFactor:l};_=new XRWebGLBinding(a,n),y=_.createProjectionLayer(ce),a.updateRenderState({layers:[y]}),e.setPixelRatio(1),e.setSize(y.textureWidth,y.textureHeight,!1),N=new Jr(y.textureWidth,y.textureHeight,{format:ci,type:Er,depthTexture:new yg(y.textureWidth,y.textureHeight,he,void 0,void 0,void 0,void 0,void 0,void 0,le),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0});const ae=e.properties.get(N);ae.__ignoreDepthValues=y.ignoreDepthValues}N.isXRRenderTarget=!0,this.setFoveation(h),p=null,d=await a.requestReferenceSpace(u),ye.setContext(a),ye.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(a!==null)return a.environmentBlendMode};function ne(j){for(let le=0;le<j.removed.length;le++){const he=j.removed[le],Ae=D.indexOf(he);Ae>=0&&(D[Ae]=null,b[Ae].disconnect(he))}for(let le=0;le<j.added.length;le++){const he=j.added[le];let Ae=D.indexOf(he);if(Ae===-1){for(let ae=0;ae<b.length;ae++)if(ae>=D.length){D.push(he),Ae=ae;break}else if(D[ae]===null){D[ae]=he,Ae=ae;break}if(Ae===-1)break}const ce=b[Ae];ce&&ce.connect(he)}}const J=new Y,de=new Y;function H(j,le,he){J.setFromMatrixPosition(le.matrixWorld),de.setFromMatrixPosition(he.matrixWorld);const Ae=J.distanceTo(de),ce=le.projectionMatrix.elements,ae=he.projectionMatrix.elements,be=ce[14]/(ce[10]-1),ze=ce[14]/(ce[10]+1),q=(ce[9]+1)/ce[5],mt=(ce[9]-1)/ce[5],Ie=(ce[8]-1)/ce[0],je=(ae[8]+1)/ae[0],Ne=be*Ie,tt=be*je,Ye=Ae/(-Ie+je),R=Ye*-Ie;le.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(R),j.translateZ(Ye),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert();const A=be+Ye,te=ze+Ye,Se=Ne-R,_e=tt+(Ae-R),Me=q*ze/te*A,Ge=mt*ze/te*A;j.projectionMatrix.makePerspective(Se,_e,Me,Ge,A,te),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}function $(j,le){le===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(le.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(a===null)return;w.texture!==null&&(j.near=w.depthNear,j.far=w.depthFar),T.near=ue.near=F.near=j.near,T.far=ue.far=F.far=j.far,(P!==T.near||ee!==T.far)&&(a.updateRenderState({depthNear:T.near,depthFar:T.far}),P=T.near,ee=T.far,F.near=P,F.far=ee,ue.near=P,ue.far=ee,F.updateProjectionMatrix(),ue.updateProjectionMatrix(),j.updateProjectionMatrix());const le=j.parent,he=T.cameras;$(T,le);for(let Ae=0;Ae<he.length;Ae++)$(he[Ae],le);he.length===2?H(T,F,ue):T.projectionMatrix.copy(F.projectionMatrix),X(j,T,le)};function X(j,le,he){he===null?j.matrix.copy(le.matrixWorld):(j.matrix.copy(he.matrixWorld),j.matrix.invert(),j.matrix.multiply(le.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(le.projectionMatrix),j.projectionMatrixInverse.copy(le.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=vd*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return T},this.getFoveation=function(){if(!(y===null&&S===null))return h},this.setFoveation=function(j){h=j,y!==null&&(y.fixedFoveation=j),S!==null&&S.fixedFoveation!==void 0&&(S.fixedFoveation=j)},this.hasDepthSensing=function(){return w.texture!==null};let L=null;function W(j,le){if(g=le.getViewerPose(p||d),E=le,g!==null){const he=g.views;S!==null&&(e.setRenderTargetFramebuffer(N,S.framebuffer),e.setRenderTarget(N));let Ae=!1;he.length!==T.cameras.length&&(T.cameras.length=0,Ae=!0);for(let ae=0;ae<he.length;ae++){const be=he[ae];let ze=null;if(S!==null)ze=S.getViewport(be);else{const mt=_.getViewSubImage(y,be);ze=mt.viewport,ae===0&&(e.setRenderTargetTextures(N,mt.colorTexture,y.ignoreDepthValues?void 0:mt.depthStencilTexture),e.setRenderTarget(N))}let q=ve[ae];q===void 0&&(q=new Zn,q.layers.enable(ae),q.viewport=new sn,ve[ae]=q),q.matrix.fromArray(be.transform.matrix),q.matrix.decompose(q.position,q.quaternion,q.scale),q.projectionMatrix.fromArray(be.projectionMatrix),q.projectionMatrixInverse.copy(q.projectionMatrix).invert(),q.viewport.set(ze.x,ze.y,ze.width,ze.height),ae===0&&(T.matrix.copy(q.matrix),T.matrix.decompose(T.position,T.quaternion,T.scale)),Ae===!0&&T.cameras.push(q)}const ce=a.enabledFeatures;if(ce&&ce.includes("depth-sensing")){const ae=_.getDepthInformation(he[0]);ae&&ae.isValid&&ae.texture&&w.init(e,ae,a.renderState)}}for(let he=0;he<b.length;he++){const Ae=D[he],ce=b[he];Ae!==null&&ce!==void 0&&ce.update(Ae,le,p||d)}w.render(e,T),L&&L(j,le),le.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:le}),E=null}const ye=new xg;ye.setAnimationLoop(W),this.setAnimationLoop=function(j){L=j},this.dispose=function(){}}}function XE(s,e){function n(v,x){v.matrixAutoUpdate===!0&&v.updateMatrix(),x.value.copy(v.matrix)}function r(v,x){x.color.getRGB(v.fogColor.value,mg(s)),x.isFog?(v.fogNear.value=x.near,v.fogFar.value=x.far):x.isFogExp2&&(v.fogDensity.value=x.density)}function a(v,x,N,b,D){x.isMeshBasicMaterial||x.isMeshLambertMaterial?l(v,x):x.isMeshToonMaterial?(l(v,x),_(v,x)):x.isMeshPhongMaterial?(l(v,x),g(v,x)):x.isMeshStandardMaterial?(l(v,x),y(v,x),x.isMeshPhysicalMaterial&&S(v,x,D)):x.isMeshMatcapMaterial?(l(v,x),E(v,x)):x.isMeshDepthMaterial?l(v,x):x.isMeshDistanceMaterial?(l(v,x),w(v,x)):x.isMeshNormalMaterial?l(v,x):x.isLineBasicMaterial?(d(v,x),x.isLineDashedMaterial&&u(v,x)):x.isPointsMaterial?h(v,x,N,b):x.isSpriteMaterial?p(v,x):x.isShadowMaterial?(v.color.value.copy(x.color),v.opacity.value=x.opacity):x.isShaderMaterial&&(x.uniformsNeedUpdate=!1)}function l(v,x){v.opacity.value=x.opacity,x.color&&v.diffuse.value.copy(x.color),x.emissive&&v.emissive.value.copy(x.emissive).multiplyScalar(x.emissiveIntensity),x.map&&(v.map.value=x.map,n(x.map,v.mapTransform)),x.alphaMap&&(v.alphaMap.value=x.alphaMap,n(x.alphaMap,v.alphaMapTransform)),x.bumpMap&&(v.bumpMap.value=x.bumpMap,n(x.bumpMap,v.bumpMapTransform),v.bumpScale.value=x.bumpScale,x.side===Un&&(v.bumpScale.value*=-1)),x.normalMap&&(v.normalMap.value=x.normalMap,n(x.normalMap,v.normalMapTransform),v.normalScale.value.copy(x.normalScale),x.side===Un&&v.normalScale.value.negate()),x.displacementMap&&(v.displacementMap.value=x.displacementMap,n(x.displacementMap,v.displacementMapTransform),v.displacementScale.value=x.displacementScale,v.displacementBias.value=x.displacementBias),x.emissiveMap&&(v.emissiveMap.value=x.emissiveMap,n(x.emissiveMap,v.emissiveMapTransform)),x.specularMap&&(v.specularMap.value=x.specularMap,n(x.specularMap,v.specularMapTransform)),x.alphaTest>0&&(v.alphaTest.value=x.alphaTest);const N=e.get(x).envMap;if(N&&(v.envMap.value=N,v.flipEnvMap.value=N.isCubeTexture&&N.isRenderTargetTexture===!1?-1:1,v.reflectivity.value=x.reflectivity,v.ior.value=x.ior,v.refractionRatio.value=x.refractionRatio),x.lightMap){v.lightMap.value=x.lightMap;const b=s._useLegacyLights===!0?Math.PI:1;v.lightMapIntensity.value=x.lightMapIntensity*b,n(x.lightMap,v.lightMapTransform)}x.aoMap&&(v.aoMap.value=x.aoMap,v.aoMapIntensity.value=x.aoMapIntensity,n(x.aoMap,v.aoMapTransform))}function d(v,x){v.diffuse.value.copy(x.color),v.opacity.value=x.opacity,x.map&&(v.map.value=x.map,n(x.map,v.mapTransform))}function u(v,x){v.dashSize.value=x.dashSize,v.totalSize.value=x.dashSize+x.gapSize,v.scale.value=x.scale}function h(v,x,N,b){v.diffuse.value.copy(x.color),v.opacity.value=x.opacity,v.size.value=x.size*N,v.scale.value=b*.5,x.map&&(v.map.value=x.map,n(x.map,v.uvTransform)),x.alphaMap&&(v.alphaMap.value=x.alphaMap,n(x.alphaMap,v.alphaMapTransform)),x.alphaTest>0&&(v.alphaTest.value=x.alphaTest)}function p(v,x){v.diffuse.value.copy(x.color),v.opacity.value=x.opacity,v.rotation.value=x.rotation,x.map&&(v.map.value=x.map,n(x.map,v.mapTransform)),x.alphaMap&&(v.alphaMap.value=x.alphaMap,n(x.alphaMap,v.alphaMapTransform)),x.alphaTest>0&&(v.alphaTest.value=x.alphaTest)}function g(v,x){v.specular.value.copy(x.specular),v.shininess.value=Math.max(x.shininess,1e-4)}function _(v,x){x.gradientMap&&(v.gradientMap.value=x.gradientMap)}function y(v,x){v.metalness.value=x.metalness,x.metalnessMap&&(v.metalnessMap.value=x.metalnessMap,n(x.metalnessMap,v.metalnessMapTransform)),v.roughness.value=x.roughness,x.roughnessMap&&(v.roughnessMap.value=x.roughnessMap,n(x.roughnessMap,v.roughnessMapTransform)),e.get(x).envMap&&(v.envMapIntensity.value=x.envMapIntensity)}function S(v,x,N){v.ior.value=x.ior,x.sheen>0&&(v.sheenColor.value.copy(x.sheenColor).multiplyScalar(x.sheen),v.sheenRoughness.value=x.sheenRoughness,x.sheenColorMap&&(v.sheenColorMap.value=x.sheenColorMap,n(x.sheenColorMap,v.sheenColorMapTransform)),x.sheenRoughnessMap&&(v.sheenRoughnessMap.value=x.sheenRoughnessMap,n(x.sheenRoughnessMap,v.sheenRoughnessMapTransform))),x.clearcoat>0&&(v.clearcoat.value=x.clearcoat,v.clearcoatRoughness.value=x.clearcoatRoughness,x.clearcoatMap&&(v.clearcoatMap.value=x.clearcoatMap,n(x.clearcoatMap,v.clearcoatMapTransform)),x.clearcoatRoughnessMap&&(v.clearcoatRoughnessMap.value=x.clearcoatRoughnessMap,n(x.clearcoatRoughnessMap,v.clearcoatRoughnessMapTransform)),x.clearcoatNormalMap&&(v.clearcoatNormalMap.value=x.clearcoatNormalMap,n(x.clearcoatNormalMap,v.clearcoatNormalMapTransform),v.clearcoatNormalScale.value.copy(x.clearcoatNormalScale),x.side===Un&&v.clearcoatNormalScale.value.negate())),x.iridescence>0&&(v.iridescence.value=x.iridescence,v.iridescenceIOR.value=x.iridescenceIOR,v.iridescenceThicknessMinimum.value=x.iridescenceThicknessRange[0],v.iridescenceThicknessMaximum.value=x.iridescenceThicknessRange[1],x.iridescenceMap&&(v.iridescenceMap.value=x.iridescenceMap,n(x.iridescenceMap,v.iridescenceMapTransform)),x.iridescenceThicknessMap&&(v.iridescenceThicknessMap.value=x.iridescenceThicknessMap,n(x.iridescenceThicknessMap,v.iridescenceThicknessMapTransform))),x.transmission>0&&(v.transmission.value=x.transmission,v.transmissionSamplerMap.value=N.texture,v.transmissionSamplerSize.value.set(N.width,N.height),x.transmissionMap&&(v.transmissionMap.value=x.transmissionMap,n(x.transmissionMap,v.transmissionMapTransform)),v.thickness.value=x.thickness,x.thicknessMap&&(v.thicknessMap.value=x.thicknessMap,n(x.thicknessMap,v.thicknessMapTransform)),v.attenuationDistance.value=x.attenuationDistance,v.attenuationColor.value.copy(x.attenuationColor)),x.anisotropy>0&&(v.anisotropyVector.value.set(x.anisotropy*Math.cos(x.anisotropyRotation),x.anisotropy*Math.sin(x.anisotropyRotation)),x.anisotropyMap&&(v.anisotropyMap.value=x.anisotropyMap,n(x.anisotropyMap,v.anisotropyMapTransform))),v.specularIntensity.value=x.specularIntensity,v.specularColor.value.copy(x.specularColor),x.specularColorMap&&(v.specularColorMap.value=x.specularColorMap,n(x.specularColorMap,v.specularColorMapTransform)),x.specularIntensityMap&&(v.specularIntensityMap.value=x.specularIntensityMap,n(x.specularIntensityMap,v.specularIntensityMapTransform))}function E(v,x){x.matcap&&(v.matcap.value=x.matcap)}function w(v,x){const N=e.get(x).light;v.referencePosition.value.setFromMatrixPosition(N.matrixWorld),v.nearDistance.value=N.shadow.camera.near,v.farDistance.value=N.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:a}}function jE(s,e,n,r){let a={},l={},d=[];const u=n.isWebGL2?s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS):0;function h(N,b){const D=b.program;r.uniformBlockBinding(N,D)}function p(N,b){let D=a[N.id];D===void 0&&(E(N),D=g(N),a[N.id]=D,N.addEventListener("dispose",v));const V=b.program;r.updateUBOMapping(N,V);const z=e.render.frame;l[N.id]!==z&&(y(N),l[N.id]=z)}function g(N){const b=_();N.__bindingPointIndex=b;const D=s.createBuffer(),V=N.__size,z=N.usage;return s.bindBuffer(s.UNIFORM_BUFFER,D),s.bufferData(s.UNIFORM_BUFFER,V,z),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,b,D),D}function _(){for(let N=0;N<u;N++)if(d.indexOf(N)===-1)return d.push(N),N;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(N){const b=a[N.id],D=N.uniforms,V=N.__cache;s.bindBuffer(s.UNIFORM_BUFFER,b);for(let z=0,F=D.length;z<F;z++){const ue=Array.isArray(D[z])?D[z]:[D[z]];for(let ve=0,T=ue.length;ve<T;ve++){const P=ue[ve];if(S(P,z,ve,V)===!0){const ee=P.__offset,fe=Array.isArray(P.value)?P.value:[P.value];let B=0;for(let ne=0;ne<fe.length;ne++){const J=fe[ne],de=w(J);typeof J=="number"||typeof J=="boolean"?(P.__data[0]=J,s.bufferSubData(s.UNIFORM_BUFFER,ee+B,P.__data)):J.isMatrix3?(P.__data[0]=J.elements[0],P.__data[1]=J.elements[1],P.__data[2]=J.elements[2],P.__data[3]=0,P.__data[4]=J.elements[3],P.__data[5]=J.elements[4],P.__data[6]=J.elements[5],P.__data[7]=0,P.__data[8]=J.elements[6],P.__data[9]=J.elements[7],P.__data[10]=J.elements[8],P.__data[11]=0):(J.toArray(P.__data,B),B+=de.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,ee,P.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function S(N,b,D,V){const z=N.value,F=b+"_"+D;if(V[F]===void 0)return typeof z=="number"||typeof z=="boolean"?V[F]=z:V[F]=z.clone(),!0;{const ue=V[F];if(typeof z=="number"||typeof z=="boolean"){if(ue!==z)return V[F]=z,!0}else if(ue.equals(z)===!1)return ue.copy(z),!0}return!1}function E(N){const b=N.uniforms;let D=0;const V=16;for(let F=0,ue=b.length;F<ue;F++){const ve=Array.isArray(b[F])?b[F]:[b[F]];for(let T=0,P=ve.length;T<P;T++){const ee=ve[T],fe=Array.isArray(ee.value)?ee.value:[ee.value];for(let B=0,ne=fe.length;B<ne;B++){const J=fe[B],de=w(J),H=D%V;H!==0&&V-H<de.boundary&&(D+=V-H),ee.__data=new Float32Array(de.storage/Float32Array.BYTES_PER_ELEMENT),ee.__offset=D,D+=de.storage}}}const z=D%V;return z>0&&(D+=V-z),N.__size=D,N.__cache={},this}function w(N){const b={boundary:0,storage:0};return typeof N=="number"||typeof N=="boolean"?(b.boundary=4,b.storage=4):N.isVector2?(b.boundary=8,b.storage=8):N.isVector3||N.isColor?(b.boundary=16,b.storage=12):N.isVector4?(b.boundary=16,b.storage=16):N.isMatrix3?(b.boundary=48,b.storage=48):N.isMatrix4?(b.boundary=64,b.storage=64):N.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",N),b}function v(N){const b=N.target;b.removeEventListener("dispose",v);const D=d.indexOf(b.__bindingPointIndex);d.splice(D,1),s.deleteBuffer(a[b.id]),delete a[b.id],delete l[b.id]}function x(){for(const N in a)s.deleteBuffer(a[N]);d=[],a={},l={}}return{bind:h,update:p,dispose:x}}class Ag{constructor(e={}){const{canvas:n=z_(),context:r=null,depth:a=!0,stencil:l=!0,alpha:d=!1,antialias:u=!1,premultipliedAlpha:h=!0,preserveDrawingBuffer:p=!1,powerPreference:g="default",failIfMajorPerformanceCaveat:_=!1}=e;this.isWebGLRenderer=!0;let y;r!==null?y=r.getContextAttributes().alpha:y=d;const S=new Uint32Array(4),E=new Int32Array(4);let w=null,v=null;const x=[],N=[];this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=rn,this._useLegacyLights=!1,this.toneMapping=Mr,this.toneMappingExposure=1;const b=this;let D=!1,V=0,z=0,F=null,ue=-1,ve=null;const T=new sn,P=new sn;let ee=null;const fe=new We(0);let B=0,ne=n.width,J=n.height,de=1,H=null,$=null;const X=new sn(0,0,ne,J),L=new sn(0,0,ne,J);let W=!1;const ye=new _g;let j=!1,le=!1,he=null;const Ae=new Yt,ce=new Tt,ae=new Y,be={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function ze(){return F===null?de:1}let q=r;function mt(C,Z){for(let se=0;se<C.length;se++){const oe=C[se],re=n.getContext(oe,Z);if(re!==null)return re}return null}try{const C={alpha:!0,depth:a,stencil:l,antialias:u,premultipliedAlpha:h,preserveDrawingBuffer:p,powerPreference:g,failIfMajorPerformanceCaveat:_};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Td}`),n.addEventListener("webglcontextlost",Et,!1),n.addEventListener("webglcontextrestored",I,!1),n.addEventListener("webglcontextcreationerror",Ee,!1),q===null){const Z=["webgl2","webgl","experimental-webgl"];if(b.isWebGL1Renderer===!0&&Z.shift(),q=mt(Z,C),q===null)throw mt(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&q instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),q.getShaderPrecisionFormat===void 0&&(q.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(C){throw console.error("THREE.WebGLRenderer: "+C.message),C}let Ie,je,Ne,tt,Ye,R,A,te,Se,_e,Me,Ge,Ce,Fe,Ke,at,ge,gt,ft,it,qe,ke,st,_t;function wt(){Ie=new JS(q),je=new jS(q,Ie,e),Ie.init(je),ke=new zE(q,Ie,je),Ne=new FE(q,Ie,je),tt=new nM(q),Ye=new ME,R=new OE(q,Ie,Ne,Ye,je,ke,tt),A=new YS(b),te=new QS(b),Se=new cx(q,je),st=new WS(q,Ie,Se,je),_e=new eM(q,Se,tt,st),Me=new oM(q,_e,Se,tt),ft=new sM(q,je,R),at=new qS(Ye),Ge=new SE(b,A,te,Ie,je,st,at),Ce=new XE(b,Ye),Fe=new TE,Ke=new PE(Ie,je),gt=new VS(b,A,te,Ne,Me,y,h),ge=new IE(b,Me,je),_t=new jE(q,tt,je,Ne),it=new XS(q,Ie,tt,je),qe=new tM(q,Ie,tt,je),tt.programs=Ge.programs,b.capabilities=je,b.extensions=Ie,b.properties=Ye,b.renderLists=Fe,b.shadowMap=ge,b.state=Ne,b.info=tt}wt();const ct=new WE(b,q);this.xr=ct,this.getContext=function(){return q},this.getContextAttributes=function(){return q.getContextAttributes()},this.forceContextLoss=function(){const C=Ie.get("WEBGL_lose_context");C&&C.loseContext()},this.forceContextRestore=function(){const C=Ie.get("WEBGL_lose_context");C&&C.restoreContext()},this.getPixelRatio=function(){return de},this.setPixelRatio=function(C){C!==void 0&&(de=C,this.setSize(ne,J,!1))},this.getSize=function(C){return C.set(ne,J)},this.setSize=function(C,Z,se=!0){if(ct.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}ne=C,J=Z,n.width=Math.floor(C*de),n.height=Math.floor(Z*de),se===!0&&(n.style.width=C+"px",n.style.height=Z+"px"),this.setViewport(0,0,C,Z)},this.getDrawingBufferSize=function(C){return C.set(ne*de,J*de).floor()},this.setDrawingBufferSize=function(C,Z,se){ne=C,J=Z,de=se,n.width=Math.floor(C*se),n.height=Math.floor(Z*se),this.setViewport(0,0,C,Z)},this.getCurrentViewport=function(C){return C.copy(T)},this.getViewport=function(C){return C.copy(X)},this.setViewport=function(C,Z,se,oe){C.isVector4?X.set(C.x,C.y,C.z,C.w):X.set(C,Z,se,oe),Ne.viewport(T.copy(X).multiplyScalar(de).floor())},this.getScissor=function(C){return C.copy(L)},this.setScissor=function(C,Z,se,oe){C.isVector4?L.set(C.x,C.y,C.z,C.w):L.set(C,Z,se,oe),Ne.scissor(P.copy(L).multiplyScalar(de).floor())},this.getScissorTest=function(){return W},this.setScissorTest=function(C){Ne.setScissorTest(W=C)},this.setOpaqueSort=function(C){H=C},this.setTransparentSort=function(C){$=C},this.getClearColor=function(C){return C.copy(gt.getClearColor())},this.setClearColor=function(){gt.setClearColor.apply(gt,arguments)},this.getClearAlpha=function(){return gt.getClearAlpha()},this.setClearAlpha=function(){gt.setClearAlpha.apply(gt,arguments)},this.clear=function(C=!0,Z=!0,se=!0){let oe=0;if(C){let re=!1;if(F!==null){const Pe=F.texture.format;re=Pe===tg||Pe===eg||Pe===Jm}if(re){const Pe=F.texture.type,Xe=Pe===Er||Pe===yr||Pe===wd||Pe===Kr||Pe===Zm||Pe===Qm,et=gt.getClearColor(),De=gt.getClearAlpha(),lt=et.r,rt=et.g,ot=et.b;Xe?(S[0]=lt,S[1]=rt,S[2]=ot,S[3]=De,q.clearBufferuiv(q.COLOR,0,S)):(E[0]=lt,E[1]=rt,E[2]=ot,E[3]=De,q.clearBufferiv(q.COLOR,0,E))}else oe|=q.COLOR_BUFFER_BIT}Z&&(oe|=q.DEPTH_BUFFER_BIT),se&&(oe|=q.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),q.clear(oe)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){n.removeEventListener("webglcontextlost",Et,!1),n.removeEventListener("webglcontextrestored",I,!1),n.removeEventListener("webglcontextcreationerror",Ee,!1),Fe.dispose(),Ke.dispose(),Ye.dispose(),A.dispose(),te.dispose(),Me.dispose(),st.dispose(),_t.dispose(),Ge.dispose(),ct.dispose(),ct.removeEventListener("sessionstart",mn),ct.removeEventListener("sessionend",St),he&&(he.dispose(),he=null),Xt.stop()};function Et(C){C.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),D=!0}function I(){console.log("THREE.WebGLRenderer: Context Restored."),D=!1;const C=tt.autoReset,Z=ge.enabled,se=ge.autoUpdate,oe=ge.needsUpdate,re=ge.type;wt(),tt.autoReset=C,ge.enabled=Z,ge.autoUpdate=se,ge.needsUpdate=oe,ge.type=re}function Ee(C){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",C.statusMessage)}function we(C){const Z=C.target;Z.removeEventListener("dispose",we),He(Z)}function He(C){$e(C),Ye.remove(C)}function $e(C){const Z=Ye.get(C).programs;Z!==void 0&&(Z.forEach(function(se){Ge.releaseProgram(se)}),C.isShaderMaterial&&Ge.releaseShaderCache(C))}this.renderBufferDirect=function(C,Z,se,oe,re,Pe){Z===null&&(Z=be);const Xe=re.isMesh&&re.matrixWorld.determinant()<0,et=Vl(C,Z,se,oe,re);Ne.setMaterial(oe,Xe);let De=se.index,lt=1;if(oe.wireframe===!0){if(De=_e.getWireframeAttribute(se),De===void 0)return;lt=2}const rt=se.drawRange,ot=se.attributes.position;let bt=rt.start*lt,gn=(rt.start+rt.count)*lt;Pe!==null&&(bt=Math.max(bt,Pe.start*lt),gn=Math.min(gn,(Pe.start+Pe.count)*lt)),De!==null?(bt=Math.max(bt,0),gn=Math.min(gn,De.count)):ot!=null&&(bt=Math.max(bt,0),gn=Math.min(gn,ot.count));const Ht=gn-bt;if(Ht<0||Ht===1/0)return;st.setup(re,oe,et,se,De);let Mn,vt=it;if(De!==null&&(Mn=Se.get(De),vt=qe,vt.setIndex(Mn)),re.isMesh)oe.wireframe===!0?(Ne.setLineWidth(oe.wireframeLinewidth*ze()),vt.setMode(q.LINES)):vt.setMode(q.TRIANGLES);else if(re.isLine){let ut=oe.linewidth;ut===void 0&&(ut=1),Ne.setLineWidth(ut*ze()),re.isLineSegments?vt.setMode(q.LINES):re.isLineLoop?vt.setMode(q.LINE_LOOP):vt.setMode(q.LINE_STRIP)}else re.isPoints?vt.setMode(q.POINTS):re.isSprite&&vt.setMode(q.TRIANGLES);if(re.isBatchedMesh)vt.renderMultiDraw(re._multiDrawStarts,re._multiDrawCounts,re._multiDrawCount);else if(re.isInstancedMesh)vt.renderInstances(bt,Ht,re.count);else if(se.isInstancedBufferGeometry){const ut=se._maxInstanceCount!==void 0?se._maxInstanceCount:1/0,vn=Math.min(se.instanceCount,ut);vt.renderInstances(bt,Ht,vn)}else vt.render(bt,Ht)};function yt(C,Z,se){C.transparent===!0&&C.side===Bi&&C.forceSinglePass===!1?(C.side=Un,C.needsUpdate=!0,ji(C,Z,se),C.side=Tr,C.needsUpdate=!0,ji(C,Z,se),C.side=Bi):ji(C,Z,se)}this.compile=function(C,Z,se=null){se===null&&(se=C),v=Ke.get(se),v.init(),N.push(v),se.traverseVisible(function(re){re.isLight&&re.layers.test(Z.layers)&&(v.pushLight(re),re.castShadow&&v.pushShadow(re))}),C!==se&&C.traverseVisible(function(re){re.isLight&&re.layers.test(Z.layers)&&(v.pushLight(re),re.castShadow&&v.pushShadow(re))}),v.setupLights(b._useLegacyLights);const oe=new Set;return C.traverse(function(re){const Pe=re.material;if(Pe)if(Array.isArray(Pe))for(let Xe=0;Xe<Pe.length;Xe++){const et=Pe[Xe];yt(et,se,re),oe.add(et)}else yt(Pe,se,re),oe.add(Pe)}),N.pop(),v=null,oe},this.compileAsync=function(C,Z,se=null){const oe=this.compile(C,Z,se);return new Promise(re=>{function Pe(){if(oe.forEach(function(Xe){Ye.get(Xe).currentProgram.isReady()&&oe.delete(Xe)}),oe.size===0){re(C);return}setTimeout(Pe,10)}Ie.get("KHR_parallel_shader_compile")!==null?Pe():setTimeout(Pe,10)})};let At=null;function Bt(C){At&&At(C)}function mn(){Xt.stop()}function St(){Xt.start()}const Xt=new xg;Xt.setAnimationLoop(Bt),typeof self<"u"&&Xt.setContext(self),this.setAnimationLoop=function(C){At=C,ct.setAnimationLoop(C),C===null?Xt.stop():Xt.start()},ct.addEventListener("sessionstart",mn),ct.addEventListener("sessionend",St),this.render=function(C,Z){if(Z!==void 0&&Z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(D===!0)return;C.matrixWorldAutoUpdate===!0&&C.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),ct.enabled===!0&&ct.isPresenting===!0&&(ct.cameraAutoUpdate===!0&&ct.updateCamera(Z),Z=ct.getCamera()),C.isScene===!0&&C.onBeforeRender(b,C,Z,F),v=Ke.get(C,N.length),v.init(),N.push(v),Ae.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),ye.setFromProjectionMatrix(Ae),le=this.localClippingEnabled,j=at.init(this.clippingPlanes,le),w=Fe.get(C,x.length),w.init(),x.push(w),on(C,Z,0,b.sortObjects),w.finish(),b.sortObjects===!0&&w.sort(H,$),this.info.render.frame++,j===!0&&at.beginShadows();const se=v.state.shadowsArray;if(ge.render(se,C,Z),j===!0&&at.endShadows(),this.info.autoReset===!0&&this.info.reset(),(ct.enabled===!1||ct.isPresenting===!1||ct.hasDepthSensing()===!1)&&gt.render(w,C),v.setupLights(b._useLegacyLights),Z.isArrayCamera){const oe=Z.cameras;for(let re=0,Pe=oe.length;re<Pe;re++){const Xe=oe[re];Yo(w,C,Xe,Xe.viewport)}}else Yo(w,C,Z);F!==null&&(R.updateMultisampleRenderTarget(F),R.updateRenderTargetMipmap(F)),C.isScene===!0&&C.onAfterRender(b,C,Z),st.resetDefaultState(),ue=-1,ve=null,N.pop(),N.length>0?v=N[N.length-1]:v=null,x.pop(),x.length>0?w=x[x.length-1]:w=null};function on(C,Z,se,oe){if(C.visible===!1)return;if(C.layers.test(Z.layers)){if(C.isGroup)se=C.renderOrder;else if(C.isLOD)C.autoUpdate===!0&&C.update(Z);else if(C.isLight)v.pushLight(C),C.castShadow&&v.pushShadow(C);else if(C.isSprite){if(!C.frustumCulled||ye.intersectsSprite(C)){oe&&ae.setFromMatrixPosition(C.matrixWorld).applyMatrix4(Ae);const Xe=Me.update(C),et=C.material;et.visible&&w.push(C,Xe,et,se,ae.z,null)}}else if((C.isMesh||C.isLine||C.isPoints)&&(!C.frustumCulled||ye.intersectsObject(C))){const Xe=Me.update(C),et=C.material;if(oe&&(C.boundingSphere!==void 0?(C.boundingSphere===null&&C.computeBoundingSphere(),ae.copy(C.boundingSphere.center)):(Xe.boundingSphere===null&&Xe.computeBoundingSphere(),ae.copy(Xe.boundingSphere.center)),ae.applyMatrix4(C.matrixWorld).applyMatrix4(Ae)),Array.isArray(et)){const De=Xe.groups;for(let lt=0,rt=De.length;lt<rt;lt++){const ot=De[lt],bt=et[ot.materialIndex];bt&&bt.visible&&w.push(C,Xe,bt,se,ae.z,ot)}}else et.visible&&w.push(C,Xe,et,se,ae.z,null)}}const Pe=C.children;for(let Xe=0,et=Pe.length;Xe<et;Xe++)on(Pe[Xe],Z,se,oe)}function Yo(C,Z,se,oe){const re=C.opaque,Pe=C.transmissive,Xe=C.transparent;v.setupLightsView(se),j===!0&&at.setGlobalState(b.clippingPlanes,se),Pe.length>0&&wr(re,Pe,Z,se),oe&&Ne.viewport(T.copy(oe)),re.length>0&&Ei(re,Z,se),Pe.length>0&&Ei(Pe,Z,se),Xe.length>0&&Ei(Xe,Z,se),Ne.buffers.depth.setTest(!0),Ne.buffers.depth.setMask(!0),Ne.buffers.color.setMask(!0),Ne.setPolygonOffset(!1)}function wr(C,Z,se,oe){if((se.isScene===!0?se.overrideMaterial:null)!==null)return;const Pe=je.isWebGL2;he===null&&(he=new Jr(1,1,{generateMipmaps:!0,type:Ie.has("EXT_color_buffer_half_float")?Vo:Er,minFilter:$r,samples:Pe?4:0})),b.getDrawingBufferSize(ce),Pe?he.setSize(ce.x,ce.y):he.setSize(_d(ce.x),_d(ce.y));const Xe=b.getRenderTarget();b.setRenderTarget(he),b.getClearColor(fe),B=b.getClearAlpha(),B<1&&b.setClearColor(16777215,.5),b.clear();const et=b.toneMapping;b.toneMapping=Mr,Ei(C,se,oe),R.updateMultisampleRenderTarget(he),R.updateRenderTargetMipmap(he);let De=!1;for(let lt=0,rt=Z.length;lt<rt;lt++){const ot=Z[lt],bt=ot.object,gn=ot.geometry,Ht=ot.material,Mn=ot.group;if(Ht.side===Bi&&bt.layers.test(oe.layers)){const vt=Ht.side;Ht.side=Un,Ht.needsUpdate=!0,Ar(bt,se,oe,gn,Ht,Mn),Ht.side=vt,Ht.needsUpdate=!0,De=!0}}De===!0&&(R.updateMultisampleRenderTarget(he),R.updateRenderTargetMipmap(he)),b.setRenderTarget(Xe),b.setClearColor(fe,B),b.toneMapping=et}function Ei(C,Z,se){const oe=Z.isScene===!0?Z.overrideMaterial:null;for(let re=0,Pe=C.length;re<Pe;re++){const Xe=C[re],et=Xe.object,De=Xe.geometry,lt=oe===null?Xe.material:oe,rt=Xe.group;et.layers.test(se.layers)&&Ar(et,Z,se,De,lt,rt)}}function Ar(C,Z,se,oe,re,Pe){C.onBeforeRender(b,Z,se,oe,re,Pe),C.modelViewMatrix.multiplyMatrices(se.matrixWorldInverse,C.matrixWorld),C.normalMatrix.getNormalMatrix(C.modelViewMatrix),re.onBeforeRender(b,Z,se,oe,C,Pe),re.transparent===!0&&re.side===Bi&&re.forceSinglePass===!1?(re.side=Un,re.needsUpdate=!0,b.renderBufferDirect(se,Z,oe,re,C,Pe),re.side=Tr,re.needsUpdate=!0,b.renderBufferDirect(se,Z,oe,re,C,Pe),re.side=Bi):b.renderBufferDirect(se,Z,oe,re,C,Pe),C.onAfterRender(b,Z,se,oe,re,Pe)}function ji(C,Z,se){Z.isScene!==!0&&(Z=be);const oe=Ye.get(C),re=v.state.lights,Pe=v.state.shadowsArray,Xe=re.state.version,et=Ge.getParameters(C,re.state,Pe,Z,se),De=Ge.getProgramCacheKey(et);let lt=oe.programs;oe.environment=C.isMeshStandardMaterial?Z.environment:null,oe.fog=Z.fog,oe.envMap=(C.isMeshStandardMaterial?te:A).get(C.envMap||oe.environment),lt===void 0&&(C.addEventListener("dispose",we),lt=new Map,oe.programs=lt);let rt=lt.get(De);if(rt!==void 0){if(oe.currentProgram===rt&&oe.lightsStateVersion===Xe)return Ko(C,et),rt}else et.uniforms=Ge.getUniforms(C),C.onBuild(se,et,b),C.onBeforeCompile(et,b),rt=Ge.acquireProgram(et,De),lt.set(De,rt),oe.uniforms=et.uniforms;const ot=oe.uniforms;return(!C.isShaderMaterial&&!C.isRawShaderMaterial||C.clipping===!0)&&(ot.clippingPlanes=at.uniform),Ko(C,et),oe.needsLights=Zo(C),oe.lightsStateVersion=Xe,oe.needsLights&&(ot.ambientLightColor.value=re.state.ambient,ot.lightProbe.value=re.state.probe,ot.directionalLights.value=re.state.directional,ot.directionalLightShadows.value=re.state.directionalShadow,ot.spotLights.value=re.state.spot,ot.spotLightShadows.value=re.state.spotShadow,ot.rectAreaLights.value=re.state.rectArea,ot.ltc_1.value=re.state.rectAreaLTC1,ot.ltc_2.value=re.state.rectAreaLTC2,ot.pointLights.value=re.state.point,ot.pointLightShadows.value=re.state.pointShadow,ot.hemisphereLights.value=re.state.hemi,ot.directionalShadowMap.value=re.state.directionalShadowMap,ot.directionalShadowMatrix.value=re.state.directionalShadowMatrix,ot.spotShadowMap.value=re.state.spotShadowMap,ot.spotLightMatrix.value=re.state.spotLightMatrix,ot.spotLightMap.value=re.state.spotLightMap,ot.pointShadowMap.value=re.state.pointShadowMap,ot.pointShadowMatrix.value=re.state.pointShadowMatrix),oe.currentProgram=rt,oe.uniformsList=null,rt}function $o(C){if(C.uniformsList===null){const Z=C.currentProgram.getUniforms();C.uniformsList=Pl.seqWithValue(Z.seq,C.uniforms)}return C.uniformsList}function Ko(C,Z){const se=Ye.get(C);se.outputColorSpace=Z.outputColorSpace,se.batching=Z.batching,se.instancing=Z.instancing,se.instancingColor=Z.instancingColor,se.skinning=Z.skinning,se.morphTargets=Z.morphTargets,se.morphNormals=Z.morphNormals,se.morphColors=Z.morphColors,se.morphTargetsCount=Z.morphTargetsCount,se.numClippingPlanes=Z.numClippingPlanes,se.numIntersection=Z.numClipIntersection,se.vertexAlphas=Z.vertexAlphas,se.vertexTangents=Z.vertexTangents,se.toneMapping=Z.toneMapping}function Vl(C,Z,se,oe,re){Z.isScene!==!0&&(Z=be),R.resetTextureUnits();const Pe=Z.fog,Xe=oe.isMeshStandardMaterial?Z.environment:null,et=F===null?b.outputColorSpace:F.isXRRenderTarget===!0?F.texture.colorSpace:Xi,De=(oe.isMeshStandardMaterial?te:A).get(oe.envMap||Xe),lt=oe.vertexColors===!0&&!!se.attributes.color&&se.attributes.color.itemSize===4,rt=!!se.attributes.tangent&&(!!oe.normalMap||oe.anisotropy>0),ot=!!se.morphAttributes.position,bt=!!se.morphAttributes.normal,gn=!!se.morphAttributes.color;let Ht=Mr;oe.toneMapped&&(F===null||F.isXRRenderTarget===!0)&&(Ht=b.toneMapping);const Mn=se.morphAttributes.position||se.morphAttributes.normal||se.morphAttributes.color,vt=Mn!==void 0?Mn.length:0,ut=Ye.get(oe),vn=v.state.lights;if(j===!0&&(le===!0||C!==ve)){const En=C===ve&&oe.id===ue;at.setState(oe,C,En)}let Ut=!1;oe.version===ut.__version?(ut.needsLights&&ut.lightsStateVersion!==vn.state.version||ut.outputColorSpace!==et||re.isBatchedMesh&&ut.batching===!1||!re.isBatchedMesh&&ut.batching===!0||re.isInstancedMesh&&ut.instancing===!1||!re.isInstancedMesh&&ut.instancing===!0||re.isSkinnedMesh&&ut.skinning===!1||!re.isSkinnedMesh&&ut.skinning===!0||re.isInstancedMesh&&ut.instancingColor===!0&&re.instanceColor===null||re.isInstancedMesh&&ut.instancingColor===!1&&re.instanceColor!==null||ut.envMap!==De||oe.fog===!0&&ut.fog!==Pe||ut.numClippingPlanes!==void 0&&(ut.numClippingPlanes!==at.numPlanes||ut.numIntersection!==at.numIntersection)||ut.vertexAlphas!==lt||ut.vertexTangents!==rt||ut.morphTargets!==ot||ut.morphNormals!==bt||ut.morphColors!==gn||ut.toneMapping!==Ht||je.isWebGL2===!0&&ut.morphTargetsCount!==vt)&&(Ut=!0):(Ut=!0,ut.__version=oe.version);let wi=ut.currentProgram;Ut===!0&&(wi=ji(oe,Z,re));let Qo=!1,fi=!1,qi=!1;const zt=wi.getUniforms(),Vn=ut.uniforms;if(Ne.useProgram(wi.program)&&(Qo=!0,fi=!0,qi=!0),oe.id!==ue&&(ue=oe.id,fi=!0),Qo||ve!==C){zt.setValue(q,"projectionMatrix",C.projectionMatrix),zt.setValue(q,"viewMatrix",C.matrixWorldInverse);const En=zt.map.cameraPosition;En!==void 0&&En.setValue(q,ae.setFromMatrixPosition(C.matrixWorld)),je.logarithmicDepthBuffer&&zt.setValue(q,"logDepthBufFC",2/(Math.log(C.far+1)/Math.LN2)),(oe.isMeshPhongMaterial||oe.isMeshToonMaterial||oe.isMeshLambertMaterial||oe.isMeshBasicMaterial||oe.isMeshStandardMaterial||oe.isShaderMaterial)&&zt.setValue(q,"isOrthographic",C.isOrthographicCamera===!0),ve!==C&&(ve=C,fi=!0,qi=!0)}if(re.isSkinnedMesh){zt.setOptional(q,re,"bindMatrix"),zt.setOptional(q,re,"bindMatrixInverse");const En=re.skeleton;En&&(je.floatVertexTextures?(En.boneTexture===null&&En.computeBoneTexture(),zt.setValue(q,"boneTexture",En.boneTexture,R)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}re.isBatchedMesh&&(zt.setOptional(q,re,"batchingTexture"),zt.setValue(q,"batchingTexture",re._matricesTexture,R));const eo=se.morphAttributes;if((eo.position!==void 0||eo.normal!==void 0||eo.color!==void 0&&je.isWebGL2===!0)&&ft.update(re,se,wi),(fi||ut.receiveShadow!==re.receiveShadow)&&(ut.receiveShadow=re.receiveShadow,zt.setValue(q,"receiveShadow",re.receiveShadow)),oe.isMeshGouraudMaterial&&oe.envMap!==null&&(Vn.envMap.value=De,Vn.flipEnvMap.value=De.isCubeTexture&&De.isRenderTargetTexture===!1?-1:1),fi&&(zt.setValue(q,"toneMappingExposure",b.toneMappingExposure),ut.needsLights&&Ti(Vn,qi),Pe&&oe.fog===!0&&Ce.refreshFogUniforms(Vn,Pe),Ce.refreshMaterialUniforms(Vn,oe,de,J,he),Pl.upload(q,$o(ut),Vn,R)),oe.isShaderMaterial&&oe.uniformsNeedUpdate===!0&&(Pl.upload(q,$o(ut),Vn,R),oe.uniformsNeedUpdate=!1),oe.isSpriteMaterial&&zt.setValue(q,"center",re.center),zt.setValue(q,"modelViewMatrix",re.modelViewMatrix),zt.setValue(q,"normalMatrix",re.normalMatrix),zt.setValue(q,"modelMatrix",re.matrixWorld),oe.isShaderMaterial||oe.isRawShaderMaterial){const En=oe.uniformsGroups;for(let Rr=0,Jo=En.length;Rr<Jo;Rr++)if(je.isWebGL2){const es=En[Rr];_t.update(es,wi),_t.bind(es,wi)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return wi}function Ti(C,Z){C.ambientLightColor.needsUpdate=Z,C.lightProbe.needsUpdate=Z,C.directionalLights.needsUpdate=Z,C.directionalLightShadows.needsUpdate=Z,C.pointLights.needsUpdate=Z,C.pointLightShadows.needsUpdate=Z,C.spotLights.needsUpdate=Z,C.spotLightShadows.needsUpdate=Z,C.rectAreaLights.needsUpdate=Z,C.hemisphereLights.needsUpdate=Z}function Zo(C){return C.isMeshLambertMaterial||C.isMeshToonMaterial||C.isMeshPhongMaterial||C.isMeshStandardMaterial||C.isShadowMaterial||C.isShaderMaterial&&C.lights===!0}this.getActiveCubeFace=function(){return V},this.getActiveMipmapLevel=function(){return z},this.getRenderTarget=function(){return F},this.setRenderTargetTextures=function(C,Z,se){Ye.get(C.texture).__webglTexture=Z,Ye.get(C.depthTexture).__webglTexture=se;const oe=Ye.get(C);oe.__hasExternalTextures=!0,oe.__hasExternalTextures&&(oe.__autoAllocateDepthBuffer=se===void 0,oe.__autoAllocateDepthBuffer||Ie.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),oe.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(C,Z){const se=Ye.get(C);se.__webglFramebuffer=Z,se.__useDefaultFramebuffer=Z===void 0},this.setRenderTarget=function(C,Z=0,se=0){F=C,V=Z,z=se;let oe=!0,re=null,Pe=!1,Xe=!1;if(C){const De=Ye.get(C);De.__useDefaultFramebuffer!==void 0?(Ne.bindFramebuffer(q.FRAMEBUFFER,null),oe=!1):De.__webglFramebuffer===void 0?R.setupRenderTarget(C):De.__hasExternalTextures&&R.rebindTextures(C,Ye.get(C.texture).__webglTexture,Ye.get(C.depthTexture).__webglTexture);const lt=C.texture;(lt.isData3DTexture||lt.isDataArrayTexture||lt.isCompressedArrayTexture)&&(Xe=!0);const rt=Ye.get(C).__webglFramebuffer;C.isWebGLCubeRenderTarget?(Array.isArray(rt[Z])?re=rt[Z][se]:re=rt[Z],Pe=!0):je.isWebGL2&&C.samples>0&&R.useMultisampledRTT(C)===!1?re=Ye.get(C).__webglMultisampledFramebuffer:Array.isArray(rt)?re=rt[se]:re=rt,T.copy(C.viewport),P.copy(C.scissor),ee=C.scissorTest}else T.copy(X).multiplyScalar(de).floor(),P.copy(L).multiplyScalar(de).floor(),ee=W;if(Ne.bindFramebuffer(q.FRAMEBUFFER,re)&&je.drawBuffers&&oe&&Ne.drawBuffers(C,re),Ne.viewport(T),Ne.scissor(P),Ne.setScissorTest(ee),Pe){const De=Ye.get(C.texture);q.framebufferTexture2D(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0,q.TEXTURE_CUBE_MAP_POSITIVE_X+Z,De.__webglTexture,se)}else if(Xe){const De=Ye.get(C.texture),lt=Z||0;q.framebufferTextureLayer(q.FRAMEBUFFER,q.COLOR_ATTACHMENT0,De.__webglTexture,se||0,lt)}ue=-1},this.readRenderTargetPixels=function(C,Z,se,oe,re,Pe,Xe){if(!(C&&C.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let et=Ye.get(C).__webglFramebuffer;if(C.isWebGLCubeRenderTarget&&Xe!==void 0&&(et=et[Xe]),et){Ne.bindFramebuffer(q.FRAMEBUFFER,et);try{const De=C.texture,lt=De.format,rt=De.type;if(lt!==ci&&ke.convert(lt)!==q.getParameter(q.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const ot=rt===Vo&&(Ie.has("EXT_color_buffer_half_float")||je.isWebGL2&&Ie.has("EXT_color_buffer_float"));if(rt!==Er&&ke.convert(rt)!==q.getParameter(q.IMPLEMENTATION_COLOR_READ_TYPE)&&!(rt===Hi&&(je.isWebGL2||Ie.has("OES_texture_float")||Ie.has("WEBGL_color_buffer_float")))&&!ot){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=C.width-oe&&se>=0&&se<=C.height-re&&q.readPixels(Z,se,oe,re,ke.convert(lt),ke.convert(rt),Pe)}finally{const De=F!==null?Ye.get(F).__webglFramebuffer:null;Ne.bindFramebuffer(q.FRAMEBUFFER,De)}}},this.copyFramebufferToTexture=function(C,Z,se=0){const oe=Math.pow(2,-se),re=Math.floor(Z.image.width*oe),Pe=Math.floor(Z.image.height*oe);R.setTexture2D(Z,0),q.copyTexSubImage2D(q.TEXTURE_2D,se,0,0,C.x,C.y,re,Pe),Ne.unbindTexture()},this.copyTextureToTexture=function(C,Z,se,oe=0){const re=Z.image.width,Pe=Z.image.height,Xe=ke.convert(se.format),et=ke.convert(se.type);R.setTexture2D(se,0),q.pixelStorei(q.UNPACK_FLIP_Y_WEBGL,se.flipY),q.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL,se.premultiplyAlpha),q.pixelStorei(q.UNPACK_ALIGNMENT,se.unpackAlignment),Z.isDataTexture?q.texSubImage2D(q.TEXTURE_2D,oe,C.x,C.y,re,Pe,Xe,et,Z.image.data):Z.isCompressedTexture?q.compressedTexSubImage2D(q.TEXTURE_2D,oe,C.x,C.y,Z.mipmaps[0].width,Z.mipmaps[0].height,Xe,Z.mipmaps[0].data):q.texSubImage2D(q.TEXTURE_2D,oe,C.x,C.y,Xe,et,Z.image),oe===0&&se.generateMipmaps&&q.generateMipmap(q.TEXTURE_2D),Ne.unbindTexture()},this.copyTextureToTexture3D=function(C,Z,se,oe,re=0){if(b.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Pe=C.max.x-C.min.x+1,Xe=C.max.y-C.min.y+1,et=C.max.z-C.min.z+1,De=ke.convert(oe.format),lt=ke.convert(oe.type);let rt;if(oe.isData3DTexture)R.setTexture3D(oe,0),rt=q.TEXTURE_3D;else if(oe.isDataArrayTexture||oe.isCompressedArrayTexture)R.setTexture2DArray(oe,0),rt=q.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}q.pixelStorei(q.UNPACK_FLIP_Y_WEBGL,oe.flipY),q.pixelStorei(q.UNPACK_PREMULTIPLY_ALPHA_WEBGL,oe.premultiplyAlpha),q.pixelStorei(q.UNPACK_ALIGNMENT,oe.unpackAlignment);const ot=q.getParameter(q.UNPACK_ROW_LENGTH),bt=q.getParameter(q.UNPACK_IMAGE_HEIGHT),gn=q.getParameter(q.UNPACK_SKIP_PIXELS),Ht=q.getParameter(q.UNPACK_SKIP_ROWS),Mn=q.getParameter(q.UNPACK_SKIP_IMAGES),vt=se.isCompressedTexture?se.mipmaps[re]:se.image;q.pixelStorei(q.UNPACK_ROW_LENGTH,vt.width),q.pixelStorei(q.UNPACK_IMAGE_HEIGHT,vt.height),q.pixelStorei(q.UNPACK_SKIP_PIXELS,C.min.x),q.pixelStorei(q.UNPACK_SKIP_ROWS,C.min.y),q.pixelStorei(q.UNPACK_SKIP_IMAGES,C.min.z),se.isDataTexture||se.isData3DTexture?q.texSubImage3D(rt,re,Z.x,Z.y,Z.z,Pe,Xe,et,De,lt,vt.data):se.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),q.compressedTexSubImage3D(rt,re,Z.x,Z.y,Z.z,Pe,Xe,et,De,vt.data)):q.texSubImage3D(rt,re,Z.x,Z.y,Z.z,Pe,Xe,et,De,lt,vt),q.pixelStorei(q.UNPACK_ROW_LENGTH,ot),q.pixelStorei(q.UNPACK_IMAGE_HEIGHT,bt),q.pixelStorei(q.UNPACK_SKIP_PIXELS,gn),q.pixelStorei(q.UNPACK_SKIP_ROWS,Ht),q.pixelStorei(q.UNPACK_SKIP_IMAGES,Mn),re===0&&oe.generateMipmaps&&q.generateMipmap(rt),Ne.unbindTexture()},this.initTexture=function(C){C.isCubeTexture?R.setTextureCube(C,0):C.isData3DTexture?R.setTexture3D(C,0):C.isDataArrayTexture||C.isCompressedArrayTexture?R.setTexture2DArray(C,0):R.setTexture2D(C,0),Ne.unbindTexture()},this.resetState=function(){V=0,z=0,F=null,Ne.reset(),st.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Vi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=e===Ad?"display-p3":"srgb",n.unpackColorSpace=Ct.workingColorSpace===zl?"display-p3":"srgb"}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===rn?Qr:ig}set outputEncoding(e){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=e===Qr?rn:Xi}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(e){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=e}}class qE extends Ag{}qE.prototype.isWebGL1Renderer=!0;class Cd{constructor(e,n=25e-5){this.isFogExp2=!0,this.name="",this.color=new We(e),this.density=n}clone(){return new Cd(this.color,this.density)}toJSON(){return{type:"FogExp2",name:this.name,color:this.color.getHex(),density:this.density}}}class YE extends Fn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,n){return super.copy(e,n),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const n=super.toJSON(e);return this.fog!==null&&(n.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(n.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(n.object.backgroundIntensity=this.backgroundIntensity),n}}class Rg extends jo{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new We(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Dm=new Yt,yd=new cg,Tl=new kl,wl=new Y;class Sd extends Fn{constructor(e=new di,n=new Rg){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=n,this.updateMorphTargets()}copy(e,n){return super.copy(e,n),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,n){const r=this.geometry,a=this.matrixWorld,l=e.params.Points.threshold,d=r.drawRange;if(r.boundingSphere===null&&r.computeBoundingSphere(),Tl.copy(r.boundingSphere),Tl.applyMatrix4(a),Tl.radius+=l,e.ray.intersectsSphere(Tl)===!1)return;Dm.copy(a).invert(),yd.copy(e.ray).applyMatrix4(Dm);const u=l/((this.scale.x+this.scale.y+this.scale.z)/3),h=u*u,p=r.index,_=r.attributes.position;if(p!==null){const y=Math.max(0,d.start),S=Math.min(p.count,d.start+d.count);for(let E=y,w=S;E<w;E++){const v=p.getX(E);wl.fromBufferAttribute(_,v),Nm(wl,v,h,a,e,n,this)}}else{const y=Math.max(0,d.start),S=Math.min(_.count,d.start+d.count);for(let E=y,w=S;E<w;E++)wl.fromBufferAttribute(_,E),Nm(wl,E,h,a,e,n,this)}}updateMorphTargets(){const n=this.geometry.morphAttributes,r=Object.keys(n);if(r.length>0){const a=n[r[0]];if(a!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let l=0,d=a.length;l<d;l++){const u=a[l].name||String(l);this.morphTargetInfluences.push(0),this.morphTargetDictionary[u]=l}}}}}function Nm(s,e,n,r,a,l,d){const u=yd.distanceSqToPoint(s);if(u<n){const h=new Y;yd.closestPointToPoint(s,h),h.applyMatrix4(r);const p=a.ray.origin.distanceTo(h);if(p<a.near||p>a.far)return;l.push({distance:p,distanceToRay:Math.sqrt(u),point:h,index:e,face:null,object:d})}}class $E{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(e,n){const r=this.getUtoTmapping(e);return this.getPoint(r,n)}getPoints(e=5){const n=[];for(let r=0;r<=e;r++)n.push(this.getPoint(r/e));return n}getSpacedPoints(e=5){const n=[];for(let r=0;r<=e;r++)n.push(this.getPointAt(r/e));return n}getLength(){const e=this.getLengths();return e[e.length-1]}getLengths(e=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===e+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const n=[];let r,a=this.getPoint(0),l=0;n.push(0);for(let d=1;d<=e;d++)r=this.getPoint(d/e),l+=r.distanceTo(a),n.push(l),a=r;return this.cacheArcLengths=n,n}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(e,n){const r=this.getLengths();let a=0;const l=r.length;let d;n?d=n:d=e*r[l-1];let u=0,h=l-1,p;for(;u<=h;)if(a=Math.floor(u+(h-u)/2),p=r[a]-d,p<0)u=a+1;else if(p>0)h=a-1;else{h=a;break}if(a=h,r[a]===d)return a/(l-1);const g=r[a],y=r[a+1]-g,S=(d-g)/y;return(a+S)/(l-1)}getTangent(e,n){let a=e-1e-4,l=e+1e-4;a<0&&(a=0),l>1&&(l=1);const d=this.getPoint(a),u=this.getPoint(l),h=n||(d.isVector2?new Tt:new Y);return h.copy(u).sub(d).normalize(),h}getTangentAt(e,n){const r=this.getUtoTmapping(e);return this.getTangent(r,n)}computeFrenetFrames(e,n){const r=new Y,a=[],l=[],d=[],u=new Y,h=new Yt;for(let S=0;S<=e;S++){const E=S/e;a[S]=this.getTangentAt(E,new Y)}l[0]=new Y,d[0]=new Y;let p=Number.MAX_VALUE;const g=Math.abs(a[0].x),_=Math.abs(a[0].y),y=Math.abs(a[0].z);g<=p&&(p=g,r.set(1,0,0)),_<=p&&(p=_,r.set(0,1,0)),y<=p&&r.set(0,0,1),u.crossVectors(a[0],r).normalize(),l[0].crossVectors(a[0],u),d[0].crossVectors(a[0],l[0]);for(let S=1;S<=e;S++){if(l[S]=l[S-1].clone(),d[S]=d[S-1].clone(),u.crossVectors(a[S-1],a[S]),u.length()>Number.EPSILON){u.normalize();const E=Math.acos(pn(a[S-1].dot(a[S]),-1,1));l[S].applyMatrix4(h.makeRotationAxis(u,E))}d[S].crossVectors(a[S],l[S])}if(n===!0){let S=Math.acos(pn(l[0].dot(l[e]),-1,1));S/=e,a[0].dot(u.crossVectors(l[0],l[e]))>0&&(S=-S);for(let E=1;E<=e;E++)l[E].applyMatrix4(h.makeRotationAxis(a[E],S*E)),d[E].crossVectors(a[E],l[E])}return{tangents:a,normals:l,binormals:d}}clone(){return new this.constructor().copy(this)}copy(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}toJSON(){const e={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return e.arcLengthDivisions=this.arcLengthDivisions,e.type=this.type,e}fromJSON(e){return this.arcLengthDivisions=e.arcLengthDivisions,this}}function bd(){let s=0,e=0,n=0,r=0;function a(l,d,u,h){s=l,e=u,n=-3*l+3*d-2*u-h,r=2*l-2*d+u+h}return{initCatmullRom:function(l,d,u,h,p){a(d,u,p*(u-l),p*(h-d))},initNonuniformCatmullRom:function(l,d,u,h,p,g,_){let y=(d-l)/p-(u-l)/(p+g)+(u-d)/g,S=(u-d)/g-(h-d)/(g+_)+(h-u)/_;y*=g,S*=g,a(d,u,y,S)},calc:function(l){const d=l*l,u=d*l;return s+e*l+n*d+r*u}}}const Al=new Y,rd=new bd,sd=new bd,od=new bd;class Md extends $E{constructor(e=[],n=!1,r="centripetal",a=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=e,this.closed=n,this.curveType=r,this.tension=a}getPoint(e,n=new Y){const r=n,a=this.points,l=a.length,d=(l-(this.closed?0:1))*e;let u=Math.floor(d),h=d-u;this.closed?u+=u>0?0:(Math.floor(Math.abs(u)/l)+1)*l:h===0&&u===l-1&&(u=l-2,h=1);let p,g;this.closed||u>0?p=a[(u-1)%l]:(Al.subVectors(a[0],a[1]).add(a[0]),p=Al);const _=a[u%l],y=a[(u+1)%l];if(this.closed||u+2<l?g=a[(u+2)%l]:(Al.subVectors(a[l-1],a[l-2]).add(a[l-1]),g=Al),this.curveType==="centripetal"||this.curveType==="chordal"){const S=this.curveType==="chordal"?.5:.25;let E=Math.pow(p.distanceToSquared(_),S),w=Math.pow(_.distanceToSquared(y),S),v=Math.pow(y.distanceToSquared(g),S);w<1e-4&&(w=1),E<1e-4&&(E=w),v<1e-4&&(v=w),rd.initNonuniformCatmullRom(p.x,_.x,y.x,g.x,E,w,v),sd.initNonuniformCatmullRom(p.y,_.y,y.y,g.y,E,w,v),od.initNonuniformCatmullRom(p.z,_.z,y.z,g.z,E,w,v)}else this.curveType==="catmullrom"&&(rd.initCatmullRom(p.x,_.x,y.x,g.x,this.tension),sd.initCatmullRom(p.y,_.y,y.y,g.y,this.tension),od.initCatmullRom(p.z,_.z,y.z,g.z,this.tension));return r.set(rd.calc(h),sd.calc(h),od.calc(h)),r}copy(e){super.copy(e),this.points=[];for(let n=0,r=e.points.length;n<r;n++){const a=e.points[n];this.points.push(a.clone())}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}toJSON(){const e=super.toJSON();e.points=[];for(let n=0,r=this.points.length;n<r;n++){const a=this.points[n];e.points.push(a.toArray())}return e.closed=this.closed,e.curveType=this.curveType,e.tension=this.tension,e}fromJSON(e){super.fromJSON(e),this.points=[];for(let n=0,r=e.points.length;n<r;n++){const a=e.points[n];this.points.push(new Y().fromArray(a))}return this.closed=e.closed,this.curveType=e.curveType,this.tension=e.tension,this}}class KE{constructor(e=!0){this.autoStart=e,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=Um(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let e=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const n=Um();e=(n-this.oldTime)/1e3,this.oldTime=n,this.elapsedTime+=e}return e}}function Um(){return(typeof performance>"u"?Date:performance).now()}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Td}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Td);const _i={bg:new We("#04060a"),fog:new We("#04060a"),soil:new We("#241813"),soilDeep:new We("#0c0806"),scan:new We("#37e6d0"),node:new We("#7bffd6"),seed:new We("#8a5a32"),bark:new We("#5b4327"),barkTip:new We("#8fe6b0"),leaf:new We("#2f9e46"),leafGloss:new We("#7fffa8"),blossom:new We("#fff3c4"),appleUnripe:new We("#7cae3a"),appleRipe:new We("#cf2130"),appleBlush:new We("#f2544a")},js=(s,e=0,n=1)=>Math.min(n,Math.max(e,s)),ks=(s,e,n)=>s+(e-s)*n;function hn(s,e,n){const r=js((s-e)/(n-e));return r*r*(3-2*r)}function ZE(s){let e=s>>>0;return function(){e|=0,e=e+1831565813|0;let n=Math.imul(e^e>>>15,1|e);return n=n+Math.imul(n^n>>>7,61|n)^n,((n^n>>>14)>>>0)/4294967296}}function QE(s=7,e={}){const{trunkHeight:n=5.2,branchLenMul:r=1,tiltMul:a=1,leafCountMul:l=1,leafScaleMul:d=1}=e,u=ZE(s),h=(v,x)=>v+u()*(x-v),p=[],g=[],_=[];let y=1e-4;function S(v,x,N,b,D,V,z){const ue=[],ve=new Y(0,1,0),T=new Y(h(-1,1),0,h(-1,1)).normalize(),P=V===0?0:h(.08,.22);v.clone(),x.clone().normalize().multiplyScalar(N/7);for(let H=0;H<=7;H++){const $=H/7,X=v.clone().addScaledVector(x.clone().normalize(),N*$);X.addScaledVector(T,Math.sin($*Math.PI)*N*.06*h(.5,1.2)),X.y-=P*N*$*$,ue.push(X)}const ee=new Md(ue),fe=z+N,B={curve:ee,r0:b,r1:D,depth:V,startDist:z,endDist:fe,gStart:0,gEnd:0};p.push(B),y=Math.max(y,fe);const ne=ue[ue.length-1],J=ne.clone().sub(ue[ue.length-2]).normalize();if(V>=2){const H=Math.floor(h(3,7)*l);for(let $=0;$<H;$++){const X=h(.35,1),L=ee.getPoint(X),W=z+N*X,j=new Y(L.x,0,L.z).normalize().clone().lerp(ve,.35).addScaledVector(new Y(h(-1,1),h(-.3,1),h(-1,1)),.5).normalize();g.push({pos:L,normal:j,scale:h(.7,1.25)*d,spin:h(0,Math.PI*2),growth:W})}}if(V>=2&&u()<.55){const H=ne.clone();H.y-=D*2+.15,_.push({pos:H,scale:h(.8,1.15),growth:fe,anchor:ne.clone()})}if(V<4){const H=V===0?4:V===1?3:2;for(let $=0;$<H;$++){const X=V===0?h(.82,1):h(.45,.95),L=ee.getPoint(X),W=z+N*X,ye=$/H*Math.PI*2+h(-.5,.5),j=(V===0?h(.5,.9):h(.6,1.15))*a,le=new Y(Math.cos(ye)*Math.sin(j),Math.cos(j)+.35,Math.sin(ye)*Math.sin(j)).normalize();le.lerp(J,.25).normalize();const he=N*h(.55,.75)*r,Ae=D*h(.7,.95),ce=Ae*.55;S(L,le,he,Ae,ce,V+1,W)}}}S(new Y(0,0,0),new Y(.05,1,.02),n,.55,.34,0,0);for(const v of p)v.gStart=v.startDist/y,v.gEnd=v.endDist/y;for(const v of g)v.growth/=y;for(const v of _)v.growth/=y;let E=0,w=-1/0;return _.forEach((v,x)=>{const N=v.pos.y+v.pos.z*.4-Math.abs(v.pos.x)*.2;N>w&&(w=N,E=x)}),{branches:p,leaves:g,fruits:_,fallIndex:E,maxDist:y}}function JE(s={}){return new Mi({transparent:!0,depthWrite:!1,depthTest:!0,blending:Go,uniforms:{uReveal:{value:0},uTime:{value:0},uSize:{value:s.size??2},uDrift:{value:s.drift??.14},uOpacity:{value:s.opacity??1},uFall:{value:1},uFallHeight:{value:s.fallHeight??0},uRipen:{value:-1},uUnripe:{value:new We("#7cae3a")},uRipe:{value:new We("#cf2130")},uBlush:{value:new We("#f2544a")},uAlpha:{value:.28},uDarken:{value:1}},vertexShader:`
