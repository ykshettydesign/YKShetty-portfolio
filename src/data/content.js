...
export const practiceStory = [
  {
    id: 'alignment',
    num: '01 · THE SEED',
    title: 'Start with the problem, not the ask',
    callout: {
      label: '◎ Find the overlap',
      text: 'The business has a metric to move; the user has a task to lose. I find the one change that does both — not the first solution that lands on the desk.',
    },
  ...
  },
  {
    ...
    callout: {
      label: '⌗ Map the system first',
      text: 'I map the system — dependencies, states, constraints — before I draw. The invisible part holds up everything visible.',
    },
    human: ['System & dependency map', 'Scope & constraints', 'Feasibility check'],
  ...
  },
  {
    id: 'explore',
    num: '03 · THE SPROUT',
    title: "I'd rather be wrong on paper",
    callout: {
      label: '⚑ Test it early',
      text: "Rough directions first — in front of real users and the team, while it's still cheap to be wrong. The best idea rarely starts with me.",
    },
  ...
  },
  {
    id: 'scale',
    num: '04 · THE CANOPY',
    title: 'Build it once, or build it forever',
    callout: {
      label: '⧉ Build it once',
      text: 'I turn one decision into a system — atomic components and tokens, plus the tooling to keep them honest — so the team ships the rest without me in the room.',
    },
    human: ['Design system', 'Atomic components', 'Tokens & docs'],
...
/* ── About ── */
export const about = {
  quoteLead: '"A design isn\'t finished when it works — it\'s finished when I ',
  quoteAccent: 'can\'t make it better',
  quoteTail: '."',
  paragraphs: [
